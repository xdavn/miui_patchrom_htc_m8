...
.method public getVisibilityByRssi(JI)Landroid/net/wifi/WifiConfiguration$Visibility;
    ...
    .prologue
    .line 153
    new-instance v10, Landroid/net/wifi/WifiConfiguration$Visibility;

    invoke-direct {v10}, Landroid/net/wifi/WifiConfiguration$Visibility;-><init>()V

    .line 155
    .local v10, "status":Landroid/net/wifi/WifiConfiguration$Visibility;
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    .line 169
    iget v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->num5:I

    add-int/lit8 v11, v11, 0x1

    iput v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->num5:I
    ...
    .line 180
    sget-boolean v11, Lcom/android/server/wifi/ScanDetailCache;->DBG:Z

    if-eqz v11, :cond_2

    .line 181
    const-string v11, "getVisibilityByRssi"
    ...
    iget v12, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->rssi5:I
    ...
    iput v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->rssi5:I

    .line 195
    iget-wide v12, v8, Landroid/net/wifi/ScanResult;->seen:J

    iput-wide v12, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->age5:J

    .line 196
    iget-object v11, v8, Landroid/net/wifi/ScanResult;->BSSID:Ljava/lang/String;

    iput-object v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->BSSID5:Ljava/lang/String;
    ...
    .line 176
    iget v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->num24:I

    add-int/lit8 v11, v11, 0x1

    iput v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->num24:I
    ...
    iget v12, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->rssi24:I
    ...
    iput v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->rssi24:I

    .line 202
    iget-wide v12, v8, Landroid/net/wifi/ScanResult;->seen:J

    iput-wide v12, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->age24:J

    .line 203
    iget-object v11, v8, Landroid/net/wifi/ScanResult;->BSSID:Ljava/lang/String;

    iput-object v11, v10, Landroid/net/wifi/WifiConfiguration$Visibility;->BSSID24:Ljava/lang/String;
    ...
    .line 229
    .end local v10    # "status":Landroid/net/wifi/WifiConfiguration$Visibility;
    :goto_2
    return-object v10

    .line 217
    .restart local v10    # "status":Landroid/net/wifi/WifiConfiguration$Visibility;
    :cond_8
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wifi/ScanDetailCache;->values()Ljava/util/Collection;
    ...
    .line 221
    .restart local v9    # "scanDetail":Lcom/android/server/wifi/ScanDetail;
    invoke-virtual {v9}, Lcom/android/server/wifi/ScanDetail;->getScanResult()Landroid/net/wifi/ScanResult;
    ...
    iget-wide v14, v8, Landroid/net/wifi/ScanResult;->seen:J
