...
.method public enter()V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$4200(Lcom/android/server/wifi/WifiStateMachine;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$4300(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$3600(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/AsyncChannel;
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->access$3602(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/AsyncChannel;)Lcom/android/internal/util/AsyncChannel;
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->access$4402(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/server/wifi/WifiApConfigStore;)Lcom/android/server/wifi/WifiApConfigStore;

    .line 7459
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$InitialState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mWifiApConfigStore:Lcom/android/server/wifi/WifiApConfigStore;
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$4400(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiApConfigStore;
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mWifiApConfigStore:Lcom/android/server/wifi/WifiApConfigStore;
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$4400(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiApConfigStore;
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mHotspotManager:Lcom/android/server/wifi/HtcHotspotManager;
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$4500(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/HtcHotspotManager;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/server/wifi/WifiApConfigStore;->passInstance(Lcom/android/server/wifi/HtcHotspotManager;)V

    .line 7467
    sget-object v0, Landroid/net/wifi/HtcWifiCustomizeReader$Feature;->HTC_HOTSPOT_CONFIGURATION:Landroid/net/wifi/HtcWifiCustomizeReader$Feature;
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiApConfigStore;->loadHtcApConfiguration()V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$4200(Lcom/android/server/wifi/WifiStateMachine;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$600(Lcom/android/server/wifi/WifiStateMachine;)Landroid/os/INetworkManagementService;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$4800(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiMonitor;
    ...
    const-string v6, "Failed to start HAL"
    ...
    invoke-static {v5, v9}, Lcom/android/server/wifi/WifiStateMachine;->access$4900(Lcom/android/server/wifi/WifiStateMachine;I)V
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiStateMachine;->access$5000(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v6

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Lcom/android/server/wifi/WifiStateMachine;->access$5100(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    const-string v7, "Fail to load driver, reason: "
    ...
    invoke-virtual {v7}, Lcom/android/server/wifi/WifiNative;->getNativeErrMsg()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcom/android/server/wifi/WifiNative;->getNativeErrno()I
    ...
    const-string v8, "Fail to load driver, reason: "
    ...
    invoke-virtual {v8}, Lcom/android/server/wifi/WifiNative;->getNativeErrMsg()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lcom/android/server/wifi/WifiNative;->getNativeErrno()I
    ...
    const-string v8, "Hotspot on/off error"

    invoke-static {v4, v6, v7, v8, v9}, Lcom/htc/server/report/up/HtcSystemUPLogger;->write(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v6, v4}, Lcom/android/server/wifi/WifiStateMachine;->setHtcSoftapMonitorStarted(Z)V
    ...
    invoke-static {v4, v6, v5}, Lcom/android/server/wifi/WifiStateMachine;->access$5300(Lcom/android/server/wifi/WifiStateMachine;II)V
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiStateMachine;->access$5400(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v6

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v4, v6}, Lcom/android/server/wifi/WifiStateMachine;->access$5500(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiStateMachine;->access$5600(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v6

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v4, v6}, Lcom/android/server/wifi/WifiStateMachine;->access$5700(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
