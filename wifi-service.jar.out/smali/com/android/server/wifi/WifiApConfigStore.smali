...
.field private mConfigUse:Lcom/android/server/wifi/HtcHotspotManager$configUse;

.field private mContext:Landroid/content/Context;

.field private mDefaultState:Lcom/android/internal/util/State;

.field private mGoogleApConfig:Landroid/net/wifi/WifiConfiguration;

.field private mHotspotManager:Lcom/android/server/wifi/HtcHotspotManager;

.field private mHtcApConfig:Landroid/net/wifi/WifiConfiguration;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    .line 77
    iput-object v8, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHtcApConfig:Landroid/net/wifi/WifiConfiguration;

    .line 78
    iput-object v8, p0, Lcom/android/server/wifi/WifiApConfigStore;->mGoogleApConfig:Landroid/net/wifi/WifiConfiguration;

    .line 89
    iput-object p1, p0, Lcom/android/server/wifi/WifiApConfigStore;->mContext:Landroid/content/Context;

    .line 92
    new-instance v6, Lcom/android/server/wifi/HtcWifiConfigEncryption;

    invoke-direct {v6}, Lcom/android/server/wifi/HtcWifiConfigEncryption;-><init>()V

    iput-object v6, p0, Lcom/android/server/wifi/WifiApConfigStore;->mConfigEncryption:Lcom/android/server/wifi/HtcWifiConfigEncryption;
...
.method static synthetic access$200(Lcom/android/server/wifi/WifiApConfigStore;)Landroid/net/wifi/WifiConfiguration;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiApConfigStore;

    .prologue
    .line 55
    iget-object v0, p0, Lcom/android/server/wifi/WifiApConfigStore;->mGoogleApConfig:Landroid/net/wifi/WifiConfiguration;
...
.method static synthetic access$300(Lcom/android/server/wifi/WifiApConfigStore;)Landroid/net/wifi/WifiConfiguration;
    ...
    .prologue
    .line 55
    iget-object v0, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHtcApConfig:Landroid/net/wifi/WifiConfiguration;
...
.method private htcSetDefaultApConfiguration()V
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHotspotManager:Lcom/android/server/wifi/HtcHotspotManager;

    invoke-virtual {v1, v0}, Lcom/android/server/wifi/HtcHotspotManager;->setHtcDefaultApConfiguration(Landroid/net/wifi/WifiConfiguration;)V
...
.method private writeApConfiguration(Landroid/net/wifi/WifiConfiguration;)V
    ...
    sget-object v4, Landroid/net/wifi/HtcWifiCustomizeReader$Feature;->HTC_HOTSPOT_CONFIGURATION:Landroid/net/wifi/HtcWifiCustomizeReader$Feature;
    ...
    .line 263
    iget-object v4, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHotspotManager:Lcom/android/server/wifi/HtcHotspotManager;

    invoke-virtual {v4, p1}, Lcom/android/server/wifi/HtcHotspotManager;->checkConfig(Landroid/net/wifi/WifiConfiguration;)Lcom/android/server/wifi/HtcHotspotManager$configUse;

    move-result-object v4

    sget-object v5, Lcom/android/server/wifi/HtcHotspotManager$configUse;->CONFIG_HTC:Lcom/android/server/wifi/HtcHotspotManager$configUse;

    if-ne v4, v5, :cond_3

    .line 264
    iput-object p1, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHtcApConfig:Landroid/net/wifi/WifiConfiguration;

    .line 266
    iget-object v4, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHotspotManager:Lcom/android/server/wifi/HtcHotspotManager;

    iget-object v5, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHtcApConfig:Landroid/net/wifi/WifiConfiguration;

    invoke-virtual {v4, v5}, Lcom/android/server/wifi/HtcHotspotManager;->persistApConfiguration(Landroid/net/wifi/WifiConfiguration;)V

    .line 272
    :goto_0
    iget-object v4, p0, Lcom/android/server/wifi/WifiApConfigStore;->mGoogleApConfig:Landroid/net/wifi/WifiConfiguration;

    if-eqz v4, :cond_0

    iget-object v4, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHtcApConfig:Landroid/net/wifi/WifiConfiguration;
    ...
    iput-object v6, v5, Landroid/net/wifi/WifiConfiguration;->allowedKeyManagement:Ljava/util/BitSet;

    iput-object v6, v4, Landroid/net/wifi/WifiConfiguration;->allowedKeyManagement:Ljava/util/BitSet;
    ...
    .line 298
    iget-object v4, p0, Lcom/android/server/wifi/WifiApConfigStore;->mConfigEncryption:Lcom/android/server/wifi/HtcWifiConfigEncryption;

    invoke-virtual {v4, p1}, Lcom/android/server/wifi/HtcWifiConfigEncryption;->getEncryptedKey(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    .line 269
    :cond_3
    iput-object p1, p0, Lcom/android/server/wifi/WifiApConfigStore;->mGoogleApConfig:Landroid/net/wifi/WifiConfiguration;
...
.method loadApConfiguration()V
    ...
    .line 229
    iget-object v6, p0, Lcom/android/server/wifi/WifiApConfigStore;->mConfigEncryption:Lcom/android/server/wifi/HtcWifiConfigEncryption;

    invoke-virtual {v6, v1}, Lcom/android/server/wifi/HtcWifiConfigEncryption;->getDecryptedKey(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    .line 241
    :cond_4
    iput-object v1, p0, Lcom/android/server/wifi/WifiApConfigStore;->mGoogleApConfig:Landroid/net/wifi/WifiConfiguration;
...
.method loadHtcApConfiguration()V
    .locals 10
    ...
    const-string v7, "Bad version on hotspot configuration file, set htc defaults"

    invoke-static {v6, v7}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 351
    invoke-direct {p0}, Lcom/android/server/wifi/WifiApConfigStore;->htcSetDefaultApConfiguration()V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_5
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    .line 368
    :cond_4
    iput-object v1, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHtcApConfig:Landroid/net/wifi/WifiConfiguration;

    .line 369
    iget-object v6, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHotspotManager:Lcom/android/server/wifi/HtcHotspotManager;

    iget-object v7, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHtcApConfig:Landroid/net/wifi/WifiConfiguration;

    invoke-virtual {v6, v7}, Lcom/android/server/wifi/HtcHotspotManager;->restoreHtcHotspotProfile(Landroid/net/wifi/WifiConfiguration;)V

    .line 373
    const-string v6, "persist.sys.hotspot.user_define"
...
.method public passInstance(Lcom/android/server/wifi/HtcHotspotManager;)V
    .locals 0
    .param p1, "hotspotmanager"    # Lcom/android/server/wifi/HtcHotspotManager;

    .prologue
    .line 330
    iput-object p1, p0, Lcom/android/server/wifi/WifiApConfigStore;->mHotspotManager:Lcom/android/server/wifi/HtcHotspotManager;
