...
.method public enter()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->access$11400(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/NetworkInfo$DetailedState;)Z
    ...
    invoke-static {v10, v0}, Lcom/android/server/wifi/WifiStateMachine;->access$7502(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/server/wifi/WifiStateMachine$WifiNetworkAgent;)Lcom/android/server/wifi/WifiStateMachine$WifiNetworkAgent;
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$800(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->access$15202(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/IpReachabilityMonitor;)Landroid/net/IpReachabilityMonitor;
    :try_end_0
...
.method public exit()V
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$15200(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/IpReachabilityMonitor;
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mIpReachabilityMonitor:Landroid/net/IpReachabilityMonitor;
    invoke-static {v1, v2}, Lcom/android/server/wifi/WifiStateMachine;->access$15202(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/IpReachabilityMonitor;)Landroid/net/IpReachabilityMonitor;
    ...
    iget-object v1, v1, Lcom/android/server/wifi/WifiStateMachine;->mHtcVzwStatusAndAggregation:Lcom/android/server/wifi/HtcVzwStatusAndAggregation;

    invoke-virtual {v1}, Lcom/android/server/wifi/HtcVzwStatusAndAggregation;->setVzwWifiDisconnected()V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    const-string v3, "remove to handle CMD_IP_REACHABILITY_LOST"
    ...
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$3002(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/wifi/WifiStateMachine;->access$6500(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$9500(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mWifiConfigStore:Lcom/android/server/wifi/WifiConfigStore;
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$2600(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiConfigStore;
    ...
    const-string v3, "L2Connected CMD_START_SCAN source- ignore scan due to BT SCO"
    ...
    invoke-static {v2, v6, v7}, Lcom/android/server/wifi/WifiStateMachine;->access$21502(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    invoke-static {v2, v14, v15}, Lcom/android/server/wifi/WifiStateMachine;->access$21402(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->fullBandConnectedTimeIntervalMilli:J
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$21500(Lcom/android/server/wifi/WifiStateMachine;)J
    ...
    invoke-static {}, Lcom/android/server/wifi/WifiStateMachine;->access$21800()Z
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$21900(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$22000(Lcom/android/server/wifi/WifiStateMachine;)V
    ...
    invoke-static {v2, v0}, Lcom/android/server/wifi/WifiStateMachine;->access$22100(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/wifi/WifiLinkLayerStats;)V
    ...
    invoke-static {v2, v11}, Lcom/android/server/wifi/WifiStateMachine;->access$22300(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/wifi/RssiPacketCountInfo;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/wifi/WifiStateMachine;->recoverPowerMode()V
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$15000(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$15002(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiStateMachine;->access$12000(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v3

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$22500(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$22600(Lcom/android/server/wifi/WifiStateMachine;Ljava/lang/String;)V
