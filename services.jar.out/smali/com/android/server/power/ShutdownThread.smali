...
.field private static sAnimEndTime:J
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/android/server/power/ShutdownThread;->sAnimEndTime:J
...
.method private static beginShutdownSequence(Landroid/content/Context;)V
    ...
    const-string v6, "Shutdown sequence begin"
    ...
    .line 273
    .local v3, "volumeKey":Ljava/lang/String;
    invoke-virtual {p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v5

    const-string v6, "volume_ring_speaker"
    ...
    const-string v7, " Volume_Ring_Speaker = "
    ...
    const-string v7, "Set persist.sys.bootvolume = "
    ...
    .line 277
    const-string v5, "persist.sys.bootvolume"
    ...
    .line 284
    .end local v3    # "volumeKey":Ljava/lang/String;
    .end local v4    # "volumeValue":I
    :goto_1
    const-wide/16 v6, 0x0

    sput-wide v6, Lcom/android/server/power/ShutdownThread;->sAnimEndTime:J

    .line 285
    invoke-static {}, Lcom/android/server/power/ShutdownThread;->isUseAnimation()Z

    move-result v1

    .line 289
    .local v1, "hasAnimation":Z
    ...
    .line 310
    invoke-virtual {v2, v10}, Landroid/app/ProgressDialog;->setProgressNumberFormat(Ljava/lang/String;)V

    .line 311
    invoke-virtual {v2, v9}, Landroid/app/ProgressDialog;->setProgressStyle(I)V

    .line 312
    invoke-virtual {v2, v8}, Landroid/app/ProgressDialog;->setProgress(I)V
    ...
    .line 346
    :cond_2
    const-string v5, "persist.sys.prev.powerdown"
    ...
    .line 348
    const-string v5, "persist.sys.vzwlogger.zygote"
    ...
    iput-object v2, v5, Lcom/android/server/power/ShutdownThread;->mProgressDialog:Landroid/app/ProgressDialog;
    ...
    iput-object v10, v5, Lcom/android/server/power/ShutdownThread;->mCpuWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v10, v5, Lcom/android/server/power/ShutdownThread;->mScreenWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-direct {v6}, Lcom/android/server/power/ShutdownThread$2;-><init>()V
    ...
    const-string v6, " Volume_Ring_Speaker not found"
    ...
    .restart local v1    # "hasAnimation":Z
    ...
    .line 327
    invoke-static {p0}, Lcom/android/server/power/ShutdownThread;->launchHome(Landroid/content/Context;)V

    .line 328
    invoke-static {}, Lcom/android/server/power/ShutdownThread;->startAnimation()V
...
.method private static delayForAnimation()V
    .locals 8
    ...
    .line 889
    sget-wide v2, Lcom/android/server/power/ShutdownThread;->sAnimEndTime:J
    ...
    const-string v3, "delayForAnimation"
    ...
    :goto_1
    const-string v2, "service.bootanim.end"
...
.method private static isUseAnimation()Z
    ...
    .prologue
    .line 908
    const-string v0, "service.shut.anim"
...
.method private static launchHome(Landroid/content/Context;)V
    .locals 4
    .param p0, "context"    # Landroid/content/Context;
    ...
    const-string v3, "Can not launch Home Screen (Intent.CATEGORY_HOME)!!!"
...
.method public static rebootOrShutdown(Landroid/content/Context;ZLjava/lang/String;)V
    ...
    .line 712
    invoke-static {}, Lcom/android/server/power/ShutdownThread;->delayForAnimation()V
    ...
    .line 742
    const-string v2, "service.shut.end"
    ...
    const-string v3, "Set service.shut.end = 1."
...
.method private static startAnimation()V
    .locals 4
    ...
    const-string v1, "Set service.bootanim.end = 0."

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 866
    const-string v0, "service.bootanim.end"
    ...
    const-string v1, "Set service.shut.end = 0."

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 870
    const-string v0, "service.shut.end"
    ...
    const-string v1, "start bootanim shut"
...
.method public run()V
    ...
    invoke-static {v2, v4}, Lcom/android/server/power/ShutdownThread;->deviceRebootOrShutdown(ZLjava/lang/String;)V
