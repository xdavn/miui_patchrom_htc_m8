...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput v4, p0, Lcom/android/server/TelephonyRegistry;->mOtaspMode:I
    ...
    .line 203
    iput-boolean v6, p0, Lcom/android/server/TelephonyRegistry;->mCarrierNetworkChangeState:Z
    ...
    .line 352
    invoke-static {v0}, Landroid/telephony/CellLocation;->getEmpty(I)Landroid/telephony/CellLocation;
    ...
    invoke-virtual {v1, v4}, Landroid/telephony/CellLocation;->fillInNotifierBundle(Landroid/os/Bundle;)V
    ...
    iput-object v4, p0, Lcom/android/server/TelephonyRegistry;->mAppOps:Landroid/app/AppOpsManager;
...
.method private enforceCarrierPrivilege()V
    ...
    sget-boolean v7, Lcom/android/server/TelephonyRegistry;->DBG:Z
...
.method private listen(Ljava/lang/String;Lcom/android/internal/telephony/IPhoneStateListener;IZI)V
    ...
    const-string v18, "android.permission.READ_PRIVILEGED_PHONE_STATE"
    ...
    iput-object v0, v14, Lcom/android/server/TelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;

    .line 534
    move-object/from16 v0, p1

    iput-object v0, v14, Lcom/android/server/TelephonyRegistry$Record;->callingPackage:Ljava/lang/String;

    .line 535
    iput v6, v14, Lcom/android/server/TelephonyRegistry$Record;->callerUserId:I
    ...
    iput-boolean v0, v14, Lcom/android/server/TelephonyRegistry$Record;->canReadPhoneState:Z

    .line 542
    sget-object v17, Lcom/android/internal/telephony/ACCCustomizationManager;->SENSE_VERSION:Ljava/lang/String;
    ...
    iput v0, v14, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I

    .line 560
    iget v13, v14, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I

    .line 561
    .local v13, "phoneId":I
    move/from16 v0, p3

    iput v0, v14, Lcom/android/server/TelephonyRegistry$Record;->events:I

    .line 562
    sget-boolean v17, Lcom/android/server/TelephonyRegistry;->DBG:Z
    ...
    const-string v19, "listen:  Register r="
    ...
    .line 570
    const-string v17, "override phoneid = 0 due to it is DEFAULT_PHONE_ID"
    ...
    iget-object v0, v14, Lcom/android/server/TelephonyRegistry$Record;->callingPackage:Ljava/lang/String;
    ...
    invoke-virtual {v0, v12, v15, v1}, Landroid/telephony/ServiceState;->setOperatorName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v14, v1}, Lcom/android/server/TelephonyRegistry;->validateEventsAndUserLocked(Lcom/android/server/TelephonyRegistry$Record;I)Z
    :try_end_6
    ...
    invoke-direct {v0, v14, v13}, Lcom/android/server/TelephonyRegistry;->getCallIncomingNumber(Lcom/android/server/TelephonyRegistry$Record;I)Ljava/lang/String;
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/IPhoneStateListener;->onDataConnectionRealTimeInfoChanged(Landroid/telephony/DataConnectionRealTimeInfo;)V
    :try_end_f
    ...
    .end local v10    # "i":I
    .end local v11    # "isPhoneStateEvent":Z
    ...
    :cond_16
    :try_start_14
    new-instance v14, Lcom/android/server/TelephonyRegistry$Record;

    const/16 v17, 0x0

    move-object/from16 v0, v17

    invoke-direct {v14, v0}, Lcom/android/server/TelephonyRegistry$Record;-><init>(Lcom/android/server/TelephonyRegistry$1;)V

    .line 528
    .restart local v14    # "r":Lcom/android/server/TelephonyRegistry$Record;
    iput-object v5, v14, Lcom/android/server/TelephonyRegistry$Record;->binder:Landroid/os/IBinder;
    ...
    const-string v17, "listen: add new record"
    ...
    .line 538
    .restart local v11    # "isPhoneStateEvent":Z
    :cond_18
    const/16 v17, 0x0
    ...
    invoke-static/range {p5 .. p5}, Landroid/telephony/SubscriptionManager;->isDummySubId(I)Z
    ...
    const-string v17, "listen: Unregister"
...
.method private validateEventsAndUserLocked(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    const-string v5, " r.callerUserId="
...
.method public addOnSubscriptionsChangedListener(Ljava/lang/String;Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;)V
    ...
    .line 423
    sget-boolean v6, Lcom/android/server/TelephonyRegistry;->DBG:Z
    ...
    const-string v8, "listen oscl:  Register r="
    ...
    const-string v6, "listen oscl: add new record"
...
.method idMatch(III)Z
    ...
    const-string v3, "idMatch : rSubId = "
...
.method public notifySecondSignalStrengthForSubscriber(JLandroid/telephony/SignalStrength;)V
    .locals 0
    .param p1, "subId"    # J
...
.method public notifyServiceStateForPhoneId(IILandroid/telephony/ServiceState;)V
    ...
    .line 830
    const-string v6, "notifyServiceStateForSubscriber"

    invoke-direct {p0, v6, p2, p1, p3}, Lcom/android/server/TelephonyRegistry;->logServiceStateChanged(Ljava/lang/String;IILandroid/telephony/ServiceState;)V
    ...
    invoke-virtual {p0, v6, p2, p1}, Lcom/android/server/TelephonyRegistry;->idMatch(III)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v8, "notifyServiceStateForSubscriber: callback.onSSC r="
    ...
    const-string v8, "notifyServiceStateForSubscriber: INVALID phoneId="
