...
.method private static audienceMatches(IFZLandroid/os/Bundle;)Z
    .locals 7
    .param p0, "source"    # I
    .param p1, "contactAffinity"    # F
    .param p2, "matchesException"    # Z
    ...
    const-string v5, "Encountered unknown source: "
    ...
    const-string v6, "audienceMatches("
...
.method public static matchesCallFilter(Landroid/content/Context;ILandroid/service/notification/ZenModeConfig;Landroid/os/UserHandle;Landroid/os/Bundle;Lcom/android/server/notification/ValidateNotificationPeople;IF)Z
    ...
    .line 92
    .local v1, "contactAffinity":F
    iget v2, p2, Landroid/service/notification/ZenModeConfig;->allowCallsFrom:I

    invoke-static {v2, v1, v0, p4}, Lcom/android/server/notification/ZenModeFiltering;->audienceMatches(IFZLandroid/os/Bundle;)Z

    move-result v0

    .line 94
    .local v0, "callMatches":Z
    ...
    const-string v4, "matchesCallFilter:"
    ...
    .end local v0    # "callMatches":Z
    .end local v1    # "contactAffinity":F
    :cond_3
    move v0, v2
...
.method private static shouldInterceptAudience(ILcom/android/server/notification/NotificationRecord;)Z
    ...
    invoke-static {p0, v2, v3, v0}, Lcom/android/server/notification/ZenModeFiltering;->audienceMatches(IFZLandroid/os/Bundle;)Z
