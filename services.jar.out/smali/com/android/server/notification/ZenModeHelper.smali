...
.method static synthetic access$500(Lcom/android/server/notification/ZenModeHelper;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method static synthetic access$600(Lcom/android/server/notification/ZenModeHelper;Landroid/service/notification/ZenModeConfig;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method private applyZenToRingerMode()V
    ...
    const-string v4, "zenToRinger(zen="
    ...
    invoke-static {v4}, Lcom/android/server/notification/ZenLog;->zenModeToString(I)Ljava/lang/String;
    ...
    const-string v4, " curt="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-static {v1}, Lcom/android/server/notification/ZenLog;->ringerModeToString(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/server/notification/ZenLog;->ringerModeToString(I)Ljava/lang/String;
...
.method public requestFromListener(Landroid/content/ComponentName;I)V
    ...
    .line 184
    invoke-static {p2, v5}, Landroid/app/NotificationManager;->zenModeFromInterruptionFilter(II)I
    ...
    const-string v4, "requestZenMode(newZen="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-static {v0}, Lcom/android/server/notification/ZenLog;->zenModeToString(I)Ljava/lang/String;
