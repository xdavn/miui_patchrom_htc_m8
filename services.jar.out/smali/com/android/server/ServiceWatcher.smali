...
.method private bindBestPackageLocked(Ljava/lang/String;)Z
    ...
    iget-object v14, v0, Lcom/android/server/ServiceWatcher;->mNlpSwitcher:Lcom/android/server/ServiceWatcher$NlpSwitcher;
    ...
    invoke-direct {v0, v14}, Lcom/android/server/ServiceWatcher;->isHtcNlp(Ljava/lang/String;)Z
    ...
    sget-boolean v14, Lcom/android/server/ServiceWatcher$NlpSwitcher;->IS_CHS_SKU:Z
...
.method private bindHtcNlpPackageLocked(Ljava/util/List;)Z
    ...
    iget v2, p0, Lcom/android/server/ServiceWatcher;->mVersion:I
    ...
    invoke-direct {p0, v5}, Lcom/android/server/ServiceWatcher;->isHtcNlp(Ljava/lang/String;)Z
    ...
    const-string v9, "serviceIsMultiuser"
    ...
    .line 483
    .end local v4    # "isMultiuser":Z
    .end local v5    # "packageName":Ljava/lang/String;
    .end local v6    # "rInfo":Landroid/content/pm/ResolveInfo;
    .end local v7    # "version":I
    :cond_2
    sget-boolean v8, Lcom/android/server/ServiceWatcher;->D:Z
    ...
    const-string v10, "bindHtcNlpPackage for %s, found %d, %s ,%s"
    ...
    const-string v8, "no new best package"
    ...
    .line 493
    invoke-direct {p0, v1, v2, v0}, Lcom/android/server/ServiceWatcher;->bindToPackageLocked(Ljava/lang/String;IZ)V
