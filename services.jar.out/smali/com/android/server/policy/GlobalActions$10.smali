...
.method public onServiceStateChanged(Landroid/telephony/ServiceState;)V
    ...
    # getter for: Lcom/android/server/policy/GlobalActions;->mIGlobalActionsCust:Lcom/android/server/policy/IGlobalActionsCust;
    invoke-static {v2}, Lcom/android/server/policy/GlobalActions;->access$300(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/IGlobalActionsCust;
    ...
    invoke-static {v4}, Lcom/android/server/policy/GlobalActions;->access$500(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/GlobalActions$ToggleAction$State;

    move-result-object v4

    invoke-interface {v2, v3, p1, v4}, Lcom/android/server/policy/IGlobalActionsCust;->checkAirPlaneModeState(Landroid/content/Context;Landroid/telephony/ServiceState;Lcom/android/server/policy/GlobalActions$ToggleAction$State;)Lcom/android/server/policy/GlobalActions$ToggleAction$State;
    ...
    invoke-static {v1, v2}, Lcom/android/server/policy/GlobalActions;->access$502(Lcom/android/server/policy/GlobalActions;Lcom/android/server/policy/GlobalActions$ToggleAction$State;)Lcom/android/server/policy/GlobalActions$ToggleAction$State;
    ...
    invoke-static {v1}, Lcom/android/server/policy/GlobalActions;->access$1600(Lcom/android/server/policy/GlobalActions;)Lcom/android/server/policy/GlobalActions$ToggleAction;
