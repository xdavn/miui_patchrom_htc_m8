...
.method public systemRunning()V
    ...
    .line 118
    new-instance v5, Lcom/android/server/NetworkTimeUpdateService$MyHandler;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v6

    invoke-direct {v5, p0, v6}, Lcom/android/server/NetworkTimeUpdateService$MyHandler;-><init>(Lcom/android/server/NetworkTimeUpdateService;Landroid/os/Looper;)V

    iput-object v5, p0, Lcom/android/server/NetworkTimeUpdateService;->mHandler:Landroid/os/Handler;

    .line 120
    iget-object v5, p0, Lcom/android/server/NetworkTimeUpdateService;->mHandler:Landroid/os/Handler;
    ...
    .line 122
    new-instance v5, Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;

    iget-object v6, p0, Lcom/android/server/NetworkTimeUpdateService;->mHandler:Landroid/os/Handler;

    const/4 v7, 0x1

    invoke-direct {v5, v6, v7}, Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;-><init>(Landroid/os/Handler;I)V

    iput-object v5, p0, Lcom/android/server/NetworkTimeUpdateService;->mSettingsObserver:Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;

    .line 123
    iget-object v5, p0, Lcom/android/server/NetworkTimeUpdateService;->mSettingsObserver:Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;

    iget-object v6, p0, Lcom/android/server/NetworkTimeUpdateService;->mContext:Landroid/content/Context;

    invoke-virtual {v5, v6}, Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;->observe(Landroid/content/Context;)V

    .line 127
    const-wide/32 v0, 0x5265c00

    .line 128
    .local v0, "DATE_1970_1_2":J
    const-wide v2, 0x1434b198400L

    .line 130
    .local v2, "DATE_2014_1_1":J
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    const-string v6, "Current time is 1970-1-1! Change time to 2014-1-1 by default"
