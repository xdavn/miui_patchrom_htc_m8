...
.method static synthetic access$500(Lcom/android/server/pm/UserManagerService;)Landroid/util/SparseArray;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/pm/UserManagerService;
...
.method static synthetic access$600(Lcom/android/server/pm/UserManagerService;Landroid/content/pm/UserInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/pm/UserManagerService;
...
.method private createUserInternal(Ljava/lang/String;II)Landroid/content/pm/UserInfo;
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/pm/UserManagerService;->prepareUserDirectory(Ljava/io/File;)V
...
.method private readUserListLocked()V
    ...
    const-string v12, "readUserListLocked: No owner or no user, fallbackToSingleUser"
...
.method private readUserLocked(I)Landroid/content/pm/UserInfo;
    ...
    .line 1078
    .local v12, "lastLoggedInTime":J
    const/16 v18, -0x1

    .line 1079
    .local v18, "profileGroupId":I
    const/16 v16, 0x0
    ...
    .line 1083
    .local v19, "restrictions":Landroid/os/Bundle;
    const/4 v6, 0x0

    .line 1085
    .local v6, "fis":Ljava/io/FileInputStream;
    :try_start_0
    new-instance v24, Landroid/util/AtomicFile;
    ...
    .line 1087
    .local v24, "userFile":Landroid/util/AtomicFile;
    ...
    invoke-interface {v15, v6, v0}, Lorg/xmlpull/v1/XmlPullParser;->setInput(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    .line 1097
    const-string v27, "UserManagerService"

    new-instance v28, Ljava/lang/StringBuilder;

    invoke-direct/range {v28 .. v28}, Ljava/lang/StringBuilder;-><init>()V

    const-string v29, "Unable to read user "
    ...
    .end local v24    # "userFile":Landroid/util/AtomicFile;
    :cond_2
    :goto_0
    return-object v25
    ...
    .restart local v24    # "userFile":Landroid/util/AtomicFile;
    :cond_3
    const/16 v27, 0x2
    ...
    invoke-direct {v0, v15, v1, v2}, Lcom/android/server/pm/UserManagerService;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I

    move-result v21

    .line 1103
    .local v21, "storedId":I
    move/from16 v0, v21
    ...
    const-string v28, "User id does not match the file name"
    ...
    invoke-direct {v0, v15, v1, v2, v3}, Lcom/android/server/pm/UserManagerService;->readLongAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;J)J

    move-result-wide v4

    .line 1111
    const-string v27, "lastLoggedIn"
    ...
    .line 1112
    const-string v27, "profileGroupId"
    ...
    const-string v28, "guestToRemove"
    ...
    invoke-direct {v0, v15, v1}, Lcom/android/server/pm/UserManagerService;->readRestrictionsLocked(Lorg/xmlpull/v1/XmlPullParser;Landroid/os/Bundle;)V
    :try_end_4
    ...
    const-string v29, "readUser fail, id="
    ...
    invoke-direct {v0, v1, v11, v9, v7}, Landroid/content/pm/UserInfo;-><init>(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    iput-wide v12, v0, Landroid/content/pm/UserInfo;->lastLoggedInTime:J
    ...
    .line 1157
    .local v17, "pe":Lorg/xmlpull/v1/XmlPullParserException;
    :try_start_9
    const-string v27, "UserManagerService"
    ...
    .line 1160
    .end local v17    # "pe":Lorg/xmlpull/v1/XmlPullParserException;
    :catchall_0
    move-exception v27
...
.method private writeBitmapLocked(Landroid/content/pm/UserInfo;Landroid/graphics/Bitmap;)V
    ...
    .prologue
    .line 699
    sget-boolean v6, Lcom/android/server/pm/UserManagerService;->DBG:Z
