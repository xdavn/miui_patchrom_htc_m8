...
.method public run()V
    ...
    .line 17981
    :try_start_0
    iget v3, p0, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache$PreparsePackageTask;->mID:I
    ...
    invoke-static {v11}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7100(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;)Z
    ...
    invoke-static {v11}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7200(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;)Ljava/util/List;
    ...
    :cond_0
    :goto_1
    iget v11, p0, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache$PreparsePackageTask;->mCore:I
    ...
    invoke-static {v11}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7300(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;)Ljava/util/List;
    ...
    invoke-static {v11, v9}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7400(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;Ljava/lang/String;)I
    ...
    invoke-static {v11}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7500(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;)[Ljava/lang/String;
    ...
    invoke-static {v11, v9}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7600(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;Ljava/lang/String;)Z
    :try_end_3
    ...
    const-string v13, " Abis: fail to parse library"
    ...
    invoke-static {v11}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7800(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v11}, Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;->access$7700(Lcom/android/server/pm/PackageManagerService$ParsedPackageCache;)Ljava/util/List;
    ...
    const-string v13, " Abis: no native library"
