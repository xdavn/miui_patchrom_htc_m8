...
.field public static final TAG_DISABLED_PKGS_MDM:Ljava/lang/String; = "disabled-pkgs-mdm"
...
.field final mDisabledUninstallPkgs:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field final mUpdatedDataPreloadApps:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/Settings;->DEBUG_HTC:Z
...
.method constructor <init>(Ljava/io/File;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, Lcom/android/server/pm/Settings;->mUpdatedDataPreloadApps:Landroid/util/ArrayMap;
...
.method private newUserIdLPw_Sec(Ljava/lang/Object;)I
    ...
    .line 5115
    .local v0, "MAX_SEC_APPLICATION_UIDS":I
...
.method private readCustomizePackages(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 4625
    sget-boolean v4, Lcom/android/server/pm/Settings;->DEBUG_HTC:Z
...
.method private readPackageLPw(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 3370
    .local v36, "sharedIdStr":Ljava/lang/String;
    const/16 v16, 0x0
    ...
    .line 3373
    .local v30, "legacyCpuAbiString":Ljava/lang/String;
    const/4 v7, 0x0
    ...
    .line 3378
    .local v37, "systemStr":Ljava/lang/String;
    const/16 v27, 0x0
    ...
    .line 3380
    .local v45, "volumeUuid":Ljava/lang/String;
    const/16 v43, 0x0

    .line 3381
    .local v43, "uidError":Ljava/lang/String;
    const/4 v13, 0x0
    ...
    .line 3387
    .local v33, "packageSetting":Lcom/android/server/pm/PackageSettingBase;
    const/16 v44, 0x0

    .line 3388
    .local v44, "version":Ljava/lang/String;
    const/4 v12, 0x0
    ...
    .line 3473
    .local v39, "timeStampStr":Ljava/lang/String;
    if-eqz v39, :cond_14
    ...
    .line 3503
    .local v22, "hasrsStr":Ljava/lang/String;
    if-eqz v22, :cond_6
    ...
    .end local v22    # "hasrsStr":Ljava/lang/String;
    .end local v33    # "packageSetting":Lcom/android/server/pm/PackageSettingBase;
    .end local v39    # "timeStampStr":Ljava/lang/String;
    ...
    .line 3609
    .local v26, "installStatusStr":Ljava/lang/String;
    if-eqz v26, :cond_9
    ...
    .end local v26    # "installStatusStr":Ljava/lang/String;
    .end local v32    # "outerDepth":I
    .end local v38    # "tagName":Ljava/lang/String;
    .end local v42    # "type":I
    .restart local v33    # "packageSetting":Lcom/android/server/pm/PackageSettingBase;
    :cond_c
    const/4 v3, 0x0
    ...
    .line 3479
    .restart local v39    # "timeStampStr":Ljava/lang/String;
    :cond_14
    const/4 v3, 0x0
    ...
    .line 3513
    .restart local v22    # "hasrsStr":Ljava/lang/String;
    :cond_15
    const/4 v11, 0x0
    ...
    .line 3613
    .restart local v26    # "installStatusStr":Ljava/lang/String;
    :cond_21
    const/4 v3, 0x1
...
.method private readUpdatedDataPreloadPackages(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 4658
    sget-boolean v5, Lcom/android/server/pm/Settings;->DEBUG_HTC:Z
    ...
    .line 4661
    :cond_2
    iget-object v5, p0, Lcom/android/server/pm/Settings;->mUpdatedDataPreloadApps:Landroid/util/ArrayMap;
...
.method dumpPackageLPr(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Landroid/util/ArraySet;Lcom/android/server/pm/PackageSetting;Ljava/text/SimpleDateFormat;Ljava/util/Date;Ljava/util/List;Z)V
    ...
    const-string v4, "  hasHtcSignature="
    ...
    .line 4277
    iget-boolean v4, v10, Landroid/content/pm/ApplicationInfo;->hasHtcSignature:Z
    ...
    iget-boolean v5, v10, Landroid/content/pm/ApplicationInfo;->displayed:Z
    ...
    const-string v5, ", configuredButton=0x"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v10, Landroid/content/pm/ApplicationInfo;->configuredButton:I
    ...
    const-string v5, ", configuredExtFlag=0x"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v10, Landroid/content/pm/ApplicationInfo;->configuredExtFlag:I
    ...
    .line 4282
    iget v4, v10, Landroid/content/pm/ApplicationInfo;->HTCFlags:I
    ...
    .line 4365
    .local v11, "cmp":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    if-eqz v11, :cond_30
    ...
    .line 4380
    .end local v11    # "cmp":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .end local v15    # "i$":Ljava/util/Iterator;
    .end local v16    # "lastDisabledAppCaller":Ljava/lang/String;
    .end local v21    # "s":Ljava/lang/String;
    .end local v22    # "user":Landroid/content/pm/UserInfo;
...
.method enableSystemPackageLPw(Ljava/lang/String;)Lcom/android/server/pm/PackageSetting;
    ...
    invoke-virtual {v15, v1}, Lcom/android/server/pm/PackageSetting;->setInstallerPackageName(Ljava/lang/String;)V
...
.method getSharedUserLPw_Sec(Ljava/lang/String;IIZZ)Lcom/android/server/pm/SharedUserSetting;
    .locals 1
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "pkgFlags"    # I
    .param p3, "pkgPrivateFlags"    # I
    ...
    .prologue
    .line 5087
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/server/pm/Settings;->getSharedUserLPw(Ljava/lang/String;IIZ)Lcom/android/server/pm/SharedUserSetting;
...
.method readLPw(Lcom/android/server/pm/PackageManagerService;Ljava/util/List;IZ)Z
    ...
    const-string v4, "Nothing in settings file; creating initial state"
    ...
    :cond_1c
    sget-object v3, Landroid/content/pm/PackageManager;->SENSE_VERSION:Ljava/lang/String;
...
.method writeLPr()V
    ...
    invoke-virtual/range {v21 .. v22}, Ljava/io/File;->renameTo(Ljava/io/File;)Z
    ...
    const-string v22, "Unable to backup package manager settings,  current changes will be lost at reboot"
    ...
    const-string v22, "Preserving older settings backup"
    ...
    check-cast v19, Lcom/android/server/pm/Settings$VersionInfo;

    .line 2130
    .local v19, "ver":Lcom/android/server/pm/Settings$VersionInfo;
    const/16 v21, 0x0
    ...
    .line 2133
    const-string v21, "databaseVersion"
    ...
    .line 2138
    .end local v19    # "ver":Lcom/android/server/pm/Settings$VersionInfo;
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/content/pm/VerifierDeviceIdentity;->toString()Ljava/lang/String;
    ...
    const-string v22, "read-external-storage"
    ...
    const-string v22, "permission-trees"
    ...
    invoke-virtual {v0, v15, v4}, Lcom/android/server/pm/Settings;->writePermissionLPr(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/pm/BasePermission;)V
    :try_end_0
    ...
    const-string v22, "Unable to write package manager settings, current changes will be lost at reboot"
    ...
    const-string v23, "Failed to clean up mangled file: "
    ...
    invoke-virtual {v0, v15, v14}, Lcom/android/server/pm/Settings;->writePackageLPr(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/pm/PackageSetting;)V
    :try_end_2
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2 .. :try_end_2} :catch_0
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-virtual {v0, v15, v14}, Lcom/android/server/pm/Settings;->writeDisabledSysPackageLPr(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/pm/PackageSetting;)V
    ...
    check-cast v18, Lcom/android/server/pm/SharedUserSetting;

    .line 2172
    .local v18, "usr":Lcom/android/server/pm/SharedUserSetting;
    const/16 v21, 0x0

    const-string v22, "shared-user"
    ...
    .line 2177
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/pm/SharedUserSetting;->getPermissionsState()Lcom/android/server/pm/PermissionsState;
    ...
    .line 2182
    .end local v18    # "usr":Lcom/android/server/pm/SharedUserSetting;
    :cond_b
    move-object/from16 v0, p0
    ...
    check-cast v10, Landroid/content/pm/PackageCleanItem;

    .line 2184
    .local v10, "item":Landroid/content/pm/PackageCleanItem;
    iget v0, v10, Landroid/content/pm/PackageCleanItem;->userId:I
    ...
    .line 2185
    .local v17, "userStr":Ljava/lang/String;
    const/16 v21, 0x0

    const-string v22, "cleaning-package"
    ...
    iget-object v0, v10, Landroid/content/pm/PackageCleanItem;->packageName:Ljava/lang/String;
    ...
    iget-boolean v0, v10, Landroid/content/pm/PackageCleanItem;->andCode:Z
    ...
    .line 2193
    .end local v10    # "item":Landroid/content/pm/PackageCleanItem;
    .end local v17    # "userStr":Ljava/lang/String;
    :cond_d
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v21 .. v21}, Landroid/util/ArrayMap;->entrySet()Ljava/util/Set;
    ...
    const-string v22, "renamed-package"
    ...
    check-cast v11, Landroid/content/pm/IntentFilterVerificationInfo;

    .line 2210
    .local v11, "ivi":Landroid/content/pm/IntentFilterVerificationInfo;
    move-object/from16 v0, p0

    invoke-virtual {v0, v15, v11}, Lcom/android/server/pm/Settings;->writeDomainVerificationsLPr(Lorg/xmlpull/v1/XmlSerializer;Landroid/content/pm/IntentFilterVerificationInfo;)V
    ...
    .line 2212
    .end local v11    # "ivi":Landroid/content/pm/IntentFilterVerificationInfo;
    :cond_f
    const/16 v21, 0x0
    ...
    .line 2222
    sget-object v21, Landroid/content/pm/PackageManager;->SENSE_VERSION:Ljava/lang/String;
    ...
    const-string v22, "disabled-pkgs-mdm"
    ...
    const-string v22, "disableduninstall"
    ...
    const-string v22, "preload-packages"
    ...
    iget-object v0, v0, Lcom/android/server/pm/Settings;->mUpdatedDataPreloadApps:Landroid/util/ArrayMap;
    ...
    const-string v22, "updated-preload-packages"
    ...
    .line 2257
    .restart local v6    # "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    const/16 v21, 0x0
    ...
    invoke-static/range {v21 .. v24}, Landroid/os/FileUtils;->setPermissions(Ljava/lang/String;III)I
...
.method writePackageLPr(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/pm/PackageSetting;)V
    ...
    .line 2482
    const-string v0, "htc_hasrs"

    iget v1, p2, Lcom/android/server/pm/PackageSetting;->hasRenderScript:I
