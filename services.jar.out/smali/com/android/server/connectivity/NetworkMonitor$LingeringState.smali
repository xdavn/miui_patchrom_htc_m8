...
.method public enter()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/connectivity/NetworkMonitor;->access$3302(Lcom/android/server/connectivity/NetworkMonitor;I)I
    ...
    invoke-direct {v0, v1, v4, v5, v8}, Lcom/android/server/connectivity/NetworkMonitor$CustomIntentReceiver;-><init>(Lcom/android/server/connectivity/NetworkMonitor;Ljava/lang/String;II)V
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/NetworkMonitor;->access$3400(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/NetworkMonitor;->access$3500(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/app/AlarmManager;
    ...
    # getter for: Lcom/android/server/connectivity/NetworkMonitor;->mLingerToken:I
    invoke-static {v1}, Lcom/android/server/connectivity/NetworkMonitor;->access$3300(Lcom/android/server/connectivity/NetworkMonitor;)I

    move-result v1

    const/4 v4, 0x0

    invoke-virtual {v0, v8, v1, v4}, Lcom/android/server/connectivity/NetworkMonitor;->obtainMessage(III)Landroid/os/Message;
    ...
    # getter for: Lcom/android/server/connectivity/NetworkMonitor;->mLingerDelayMs:I
    invoke-static {v1}, Lcom/android/server/connectivity/NetworkMonitor;->access$3400(Lcom/android/server/connectivity/NetworkMonitor;)I

    move-result v1

    int-to-long v4, v1

    invoke-virtual {v0, v7, v4, v5}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessageDelayed(Landroid/os/Message;J)V
...
.method public exit()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/connectivity/NetworkMonitor;->access$3700(Lcom/android/server/connectivity/NetworkMonitor;I)V
