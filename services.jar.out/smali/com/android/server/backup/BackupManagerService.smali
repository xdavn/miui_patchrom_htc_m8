...
.field static final DEBUG_SCHEDULING:Z
...
.field private static final HTC_BACKUP_PKG:Ljava/lang/String; = "com.htc.backup"
...
.field static final MORE_DEBUG:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/backup/Trampoline;)V
    ...
    iput-boolean v0, v1, Lcom/android/server/backup/BackupManagerService;->mhtcBackupExist:Z
    ...
    const-string v22, "android.backup.TRANSPORT_HOST"
    ...
    .line 1587
    new-instance v21, Lcom/android/server/backup/BackupManagerService$1;
    ...
    .line 1979
    new-instance v21, Lcom/android/server/backup/BackupManagerService$2;
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/backup/Trampoline;->asInterface(Landroid/os/IBinder;)Landroid/app/backup/IBackupManager;
    ...
    .line 1172
    new-instance v21, Lcom/android/server/backup/BackupManagerService$BackupHandler;
    ...
    .line 1181
    new-instance v21, Lcom/android/server/backup/BackupManagerService$ProvisionedObserver;
    ...
    invoke-virtual {v15, v0, v1, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V
    ...
    :cond_4
    :goto_3
    new-instance v21, Lcom/android/server/backup/BackupManagerService$RunBackupReceiver;
    ...
    .line 1249
    new-instance v21, Lcom/android/server/backup/BackupManagerService$RunInitializeReceiver;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/SystemConfig;->getBackupTransportWhitelist()Landroid/util/ArraySet;
    ...
    invoke-virtual/range {v21 .. v24}, Landroid/content/pm/PackageManager;->queryIntentServicesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    const-string v23, "Found transports: "
    ...
    .line 1300
    .local v20, "transportService":Landroid/content/pm/ServiceInfo;
    ...
    .end local v20    # "transportService":Landroid/content/pm/ServiceInfo;
    :cond_7
    const/16 v21, 0x0
    ...
    const-string v22, "Unable to read backup pw version"
    ...
    const-string v23, "Error closing pw version files"
    ...
    .line 1317
    new-instance v21, Lcom/android/server/backup/BackupManagerService$BootCompleteReceiver;
    ...
    const-string v22, "com.htc.backup"
...
.method static synthetic access$100(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$2500(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;Ljava/util/HashSet;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$2800(Lcom/android/server/backup/BackupManagerService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
...
.method private dataChangedImpl(Ljava/lang/String;Ljava/util/HashSet;)V
    ...
    iget-boolean v1, p0, Lcom/android/server/backup/BackupManagerService;->mhtcBackupExist:Z

    if-eqz v1, :cond_1

    .line 9118
    iget-object v1, p0, Lcom/android/server/backup/BackupManagerService;->mHtcPendingBackups:Ljava/util/HashMap;
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v0, v0, Lcom/android/server/backup/BackupManagerService;->mFullRestoreRunning:Z

    move/from16 v25, v0

    if-eqz v25, :cond_2

    const-string v25, "Full Restore currently running"
...
.method private readFullBackupSchedule()Ljava/util/ArrayList;
    ...
    .line 1548
    sget-boolean v28, Lcom/android/server/backup/BackupManagerService;->MORE_DEBUG:Z
    ...
    const-string v30, "New full backup app "
...
.method public BackupStatus()Ljava/lang/String;
    ...
    iget-boolean v0, p0, Lcom/android/server/backup/BackupManagerService;->mFullBackupRunning:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/backup/BackupManagerService;->mFullRestoreRunning:Z
...
.method beginFullBackup(Lcom/android/server/backup/FullBackupJob;)Z
    ...
    const-string v3, "Preconditions not met; not running full backup"
...
.method bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;I)Landroid/app/IBackupAgent;
    ...
    iput-object v6, p0, Lcom/android/server/backup/BackupManagerService;->mBindingApp:Ljava/lang/String;
...
.method public clearBackupData(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v17, "clearBackupData() of "
    ...
    .line 9217
    .local v5, "allowClearPM":Z
    :try_start_0
    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/server/backup/BackupManagerService;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iget-object v15, v0, Lcom/android/server/backup/BackupManagerService;->mContext:Landroid/content/Context;
    ...
    iget-object v15, v0, Lcom/android/server/backup/BackupManagerService;->mBackupParticipants:Landroid/util/SparseArray;
    ...
    .line 9254
    .local v6, "apps":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    :cond_0
    move-object/from16 v0, p2
    ...
    const-string v16, "Found the app - running clear process"
    ...
    iget-object v15, v0, Lcom/android/server/backup/BackupManagerService;->mBackupHandler:Lcom/android/server/backup/BackupManagerService$BackupHandler;
    ...
    new-instance v18, Lcom/android/server/backup/BackupManagerService$ClearRetryParams;
    ...
    invoke-virtual {v15, v0, v1}, Lcom/android/server/backup/BackupManagerService$BackupHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v15, v10, v0, v1}, Lcom/android/server/backup/BackupManagerService$BackupHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    .line 9277
    .end local v6    # "apps":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    const-string v16, "clear @pm@ for transport"
    ...
    iput-object v15, v9, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;
    ...
    const-string v16, "Privileged caller, allowing clear of other apps"
    ...
    .line 9243
    .restart local v6    # "apps":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    move-object/from16 v0, p0
    ...
    .line 9246
    .local v11, "s":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    if-eqz v11, :cond_7
    ...
    .end local v4    # "N":I
    .end local v8    # "i":I
    .end local v11    # "s":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    iget-object v15, v0, Lcom/android/server/backup/BackupManagerService;->mWakelock:Landroid/os/PowerManager$WakeLock;
    ...
    new-instance v18, Lcom/android/server/backup/BackupManagerService$ClearParams;

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    invoke-direct {v0, v1, v14, v9}, Lcom/android/server/backup/BackupManagerService$ClearParams;-><init>(Lcom/android/server/backup/BackupManagerService;Lcom/android/internal/backup/IBackupTransport;Landroid/content/pm/PackageInfo;)V
    ...
    invoke-virtual {v15, v10}, Lcom/android/server/backup/BackupManagerService$BackupHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public getAvailableRestoreToken(Ljava/lang/String;)J
    ...
    const-string v4, "App in ever-stored, so using current token"
...
.method public restoreAtInstall(Ljava/lang/String;I)V
    ...
    const-string v2, "No restore set"
    ...
    const-string v5, "Restore at install of "
...
.method scheduleNextFullBackupJob(J)V
    ...
    .end local v10    # "upcomingLastBackup":J
    :cond_2
    sget-boolean v7, Lcom/android/server/backup/BackupManagerService;->DEBUG_SCHEDULING:Z
...
.method tearDownAgentAndKill(Landroid/content/pm/ApplicationInfo;)V
    ...
    const-string v3, "Not killing after operation: "
