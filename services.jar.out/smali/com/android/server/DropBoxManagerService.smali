...
.method private declared-synchronized trimToFit()J
    ...
    const-string v31, "dropbox_age_seconds"
    ...
    const-string v31, "dropbox_max_files"
    ...
    invoke-virtual/range {v30 .. v30}, Ljava/util/TreeSet;->isEmpty()Z
    ...
    invoke-virtual/range {v30 .. v30}, Ljava/util/TreeSet;->first()Ljava/lang/Object;
    ...
    invoke-virtual/range {v30 .. v30}, Ljava/util/TreeSet;->size()I
    ...
    const-string v31, "dropbox_quota_percent"
    ...
    const-string v31, "dropbox_reserve_percent"
    ...
    const-string v31, "dropbox_quota_kb"
    ...
    .line 753
    .local v20, "realReservePercent":D
    move-object/from16 v0, p0
    ...
    .line 758
    const-wide v30, 0x4203880000000000L    # 1.048576E10
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/os/StatFs;->restat(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v30 .. v30}, Landroid/os/StatFs;->getBlockCountLong()J
    ...
    .end local v18    # "quotaKb":I
    .end local v19    # "quotaPercent":I
    .end local v20    # "realReservePercent":D
    .end local v22    # "reservePercent":I
    :cond_3
    move-object/from16 v0, p0
    ...
    .local v27, "unsqueezed":I
    const/16 v23, 0x0

    .line 789
    .local v23, "squeezed":I
    new-instance v26, Ljava/util/TreeSet;
    ...
    .line 790
    .local v26, "tags":Ljava/util/TreeSet;, "Ljava/util/TreeSet<Lcom/android/server/DropBoxManagerService$FileList;>;"
    invoke-virtual/range {v26 .. v26}, Ljava/util/TreeSet;->iterator()Ljava/util/Iterator;
    ...
    check-cast v24, Lcom/android/server/DropBoxManagerService$FileList;

    .line 791
    .local v24, "tag":Lcom/android/server/DropBoxManagerService$FileList;
    if-lez v23, :cond_a
    ...
    .line 797
    .end local v24    # "tag":Lcom/android/server/DropBoxManagerService$FileList;
    :cond_4
    move-object/from16 v0, p0
    ...
    .line 801
    .restart local v24    # "tag":Lcom/android/server/DropBoxManagerService$FileList;
    move-object/from16 v0, p0
    ...
    .end local v23    # "squeezed":I
    .end local v24    # "tag":Lcom/android/server/DropBoxManagerService$FileList;
    .end local v25    # "tagQuota":I
    .end local v26    # "tags":Ljava/util/TreeSet;, "Ljava/util/TreeSet<Lcom/android/server/DropBoxManagerService$FileList;>;"
    .end local v27    # "unsqueezed":I
    :cond_6
    move-object/from16 v0, p0
    ...
    .restart local v23    # "squeezed":I
    .restart local v24    # "tag":Lcom/android/server/DropBoxManagerService$FileList;
    .restart local v26    # "tags":Ljava/util/TreeSet;, "Ljava/util/TreeSet<Lcom/android/server/DropBoxManagerService$FileList;>;"
    .restart local v27    # "unsqueezed":I
    ...
    .line 809
    :cond_e
    new-instance v30, Lcom/android/server/DropBoxManagerService$EntryFile;
    ...
    const-string v31, "Can\'t write tombstone file"
