...
# static fields
.field public static final COLOR_TEMPERATURE_SETTING:Ljava/lang/String; = "color_temperature_setting"

.field private static final DEBUG:Z = false

.field private static final FORCE_WIFI_DISPLAY_ENABLE:Ljava/lang/String; = "persist.debug.wfd.enable"

.field private static final MAX_BURST_MODE_LEVEL:I = 0x14

.field private static final MIN_BURST_MODE_LEVEL:I = 0x0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 244
    iput-boolean v3, p0, Lcom/android/server/display/DisplayManagerService;->mIsStockUI:Z
    ...
    invoke-static {v1, v5}, Lcom/htc/customization/HtcCustomizationSystemReaderImpl;->readString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 260
    iput-boolean v4, p0, Lcom/android/server/display/DisplayManagerService;->mIsStockUI:Z
...
.method static synthetic access$3700(Lcom/android/server/display/DisplayManagerService;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$4300(Lcom/android/server/display/DisplayManagerService;IZFIZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # Z
...
.method static synthetic access$4400(Lcom/android/server/display/DisplayManagerService;III)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$4600(Lcom/android/server/display/DisplayManagerService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/DisplayManagerService;

    .prologue
    .line 121
    invoke-direct {p0}, Lcom/android/server/display/DisplayManagerService;->updateColorTemperatureSettings()V
...
.method private filterMaxBrightnessValue(I)I
    .locals 4
    ...
    .line 365
    .local v0, "tmpBrightness":I
    const/4 v1, 0x0

    .line 367
    .local v1, "tmpBurstModeLevel":I
    iget-boolean v3, p0, Lcom/android/server/display/DisplayManagerService;->mIsStockUI:Z
    ...
    .line 375
    .end local v0    # "tmpBrightness":I
    :cond_0
    :goto_0
    return v0

    .line 371
    .restart local v0    # "tmpBrightness":I
    :cond_1
...
.method private registerContentObserverForColorTempChanged()V
    .locals 2
    ...
    invoke-direct {v1, p0}, Lcom/android/server/display/DisplayManagerService$1;-><init>(Lcom/android/server/display/DisplayManagerService;)V
...
.method private requestGlobalDisplayStateInternal(II)V
    ...
    .line 391
    invoke-direct {p0, p2}, Lcom/android/server/display/DisplayManagerService;->filterMaxBrightnessValue(I)I
...
.method private updateColorTemperatureSettings()V
    .locals 7

    .prologue
    .line 1662
    invoke-virtual {p0}, Lcom/android/server/display/DisplayManagerService;->getContext()Landroid/content/Context;
    ...
    const-string v5, "color_temperature_setting"
    ...
    const-string v6, "updateColorTemperatureSettings, target= "
    ...
    const-string v5, "Failed to set color temperature"
...
.method public systemReady(ZZ)V
    ...
    .line 318
    invoke-direct {p0}, Lcom/android/server/display/DisplayManagerService;->registerContentObserverForColorTempChanged()V
