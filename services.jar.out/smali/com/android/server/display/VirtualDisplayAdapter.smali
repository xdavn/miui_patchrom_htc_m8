...
.method static synthetic access$200(Lcom/android/server/display/VirtualDisplayAdapter;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/VirtualDisplayAdapter;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 48
    invoke-direct {p0, p1}, Lcom/android/server/display/VirtualDisplayAdapter;->sendStatusChangedBroadcast(I)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/server/display/VirtualDisplayAdapter;Landroid/os/IBinder;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/VirtualDisplayAdapter;
    .param p1, "x1"    # Landroid/os/IBinder;
...
.method private sendStatusChangedBroadcast(I)V
    ...
    const-string v2, "Enter sendStatusChangedBroadcast, status: "
    ...
    .line 102
    invoke-virtual {p0}, Lcom/android/server/display/VirtualDisplayAdapter;->getHandler()Landroid/os/Handler;

    move-result-object v0

    new-instance v1, Lcom/android/server/display/VirtualDisplayAdapter$1;

    invoke-direct {v1, p0}, Lcom/android/server/display/VirtualDisplayAdapter$1;-><init>(Lcom/android/server/display/VirtualDisplayAdapter;)V

    invoke-virtual {v1, p1}, Lcom/android/server/display/VirtualDisplayAdapter$1;->init(I)Ljava/lang/Runnable;
...
.method public createVirtualDisplayLocked(Landroid/hardware/display/IVirtualDisplayCallback;Landroid/media/projection/IMediaProjection;ILjava/lang/String;Ljava/lang/String;IIILandroid/view/Surface;I)Lcom/android/server/display/DisplayDevice;
    ...
    invoke-direct {v0, v3}, Lcom/android/server/display/VirtualDisplayAdapter;->sendStatusChangedBroadcast(I)V
