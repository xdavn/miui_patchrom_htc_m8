...
.method static synthetic access$6700(Lcom/android/server/audio/AudioService$AudioHandler;Landroid/media/MediaPlayer;)V
    .locals 0
...
.method private onLoadSoundEffects()Z
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->access$6100(Lcom/android/server/audio/AudioService;)Z
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->access$6200(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->access$6302(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$SoundPoolListenerThread;)Lcom/android/server/audio/AudioService$SoundPoolListenerThread;
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->access$6300(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$SoundPoolListenerThread;
    ...
    invoke-static {}, Lcom/android/server/audio/AudioService;->access$6400()Ljava/util/List;
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->access$6500(Lcom/android/server/audio/AudioService;)[[I
    ...
    # getter for: Lcom/android/server/audio/AudioService;->SOUND_EFFECT_FILES_MAP:[[I
    invoke-static {v13}, Lcom/android/server/audio/AudioService;->access$6500(Lcom/android/server/audio/AudioService;)[[I
...
.method private onPlaySoundEffect(II)V
    ...
    invoke-static {}, Lcom/android/server/audio/AudioService;->access$6600()I
...
.method private setAllVolumeMirrorLink(I)V
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->access$5700(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
    ...
    # setter for: Lcom/android/server/audio/AudioService;->mLockedMusicVolume:Z
    invoke-static {v1, v2}, Lcom/android/server/audio/AudioService;->access$5202(Lcom/android/server/audio/AudioService;Z)Z
...
.method private setAllVolumes(Lcom/android/server/audio/AudioService$VolumeStreamState;)V
    ...
    # getter for: Lcom/android/server/audio/AudioService;->mStreamStates:[Lcom/android/server/audio/AudioService$VolumeStreamState;
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->access$5700(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
...
.method private setDeviceVolume(Lcom/android/server/audio/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {v0, v9}, Lcom/android/server/audio/AudioService;->access$5500(Lcom/android/server/audio/AudioService;I)I
    ...
    # getter for: Lcom/android/server/audio/AudioService;->mStreamStates:[Lcom/android/server/audio/AudioService$VolumeStreamState;
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->access$5700(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
...
.method private setDeviceVolumeHTC(Lcom/android/server/audio/AudioService$VolumeStreamState;I)V
    .locals 9
    .param p1, "streamState"    # Lcom/android/server/audio/AudioService$VolumeStreamState;
    .param p2, "device"    # I
...
.method private setForceUse(II)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/audio/AudioService;->access$6800(Lcom/android/server/audio/AudioService;II)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Lcom/android/server/audio/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->access$3100(Lcom/android/server/audio/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v3, v1}, Lcom/android/server/audio/AudioService;->access$6900(Lcom/android/server/audio/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->access$7000(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/server/audio/AudioService;->access$7100(Lcom/android/server/audio/AudioService;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->access$7200(Lcom/android/server/audio/AudioService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v2, v1, v3}, Lcom/android/server/audio/AudioService;->access$7300(Lcom/android/server/audio/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-static {v2, v1, v3}, Lcom/android/server/audio/AudioService;->access$7400(Lcom/android/server/audio/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-direct {v0, v12}, Lcom/android/server/audio/AudioService$AudioHandler;->findDeviceUniqueId(I)Ljava/lang/String;
    ...
    invoke-static {v1, v13}, Lcom/android/server/audio/AudioService;->access$7500(Lcom/android/server/audio/AudioService;Landroid/content/Intent;)V
    ...
    invoke-static {v2, v1}, Lcom/android/server/audio/AudioService;->access$7600(Lcom/android/server/audio/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v3, v2, v1}, Lcom/android/server/audio/AudioService;->access$7800(Lcom/android/server/audio/AudioService;ZLjava/lang/String;)V
    ...
    invoke-static {v1, v2, v3}, Lcom/android/server/audio/AudioService;->access$8000(Lcom/android/server/audio/AudioService;II)V
    ...
    invoke-static {v2, v1, v3}, Lcom/android/server/audio/AudioService;->access$8100(Lcom/android/server/audio/AudioService;Ljava/lang/String;I)V
    ...
    # invokes: Lcom/android/server/audio/AudioService;->handleFMRoute(II)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/audio/AudioService$AudioHandler;->setDeviceVolumeHTC(Lcom/android/server/audio/AudioService$VolumeStreamState;I)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/audio/AudioService$AudioHandler;->setAllVolumeMirrorLink(I)V
    ...
    const-string v2, "MSG_UPDATE_RINGER_MODE_AFFECTED_STREAMS_INTERNAL"
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->access$8300(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v1, v3, v4}, Lcom/android/server/audio/AudioService;->access$8500(Lcom/android/server/audio/AudioService;IZ)V
