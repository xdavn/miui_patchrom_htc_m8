...
.method static synthetic access$1476(Lcom/android/server/content/SyncManager;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # I
...
.method static synthetic access$1600(Lcom/android/server/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$1700(Lcom/android/server/content/SyncManager;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$2800(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncManager$ActiveSyncContext;
...
.method static synthetic access$2900(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncManager$ActiveSyncContext;
...
.method static synthetic access$3500(Lcom/android/server/content/SyncManager;)Landroid/os/UserManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$3600(Lcom/android/server/content/SyncManager;)Lcom/android/server/content/AppIdleMonitor;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4200(Lcom/android/server/content/SyncManager;)Landroid/net/ConnectivityManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4300(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncManager$ActiveSyncContext;
...
.method static synthetic access$4400(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncOperation;
...
.method static synthetic access$4700(Lcom/android/server/content/SyncManager;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4800(Lcom/android/server/content/SyncManager;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4900(Lcom/android/server/content/SyncManager;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$5000(Lcom/android/server/content/SyncManager;Landroid/os/UserHandle;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method private initSettingsObserver()V
    ...
    .line 442
    :cond_0
    new-instance v1, Lcom/android/server/content/SyncManager$SettingsObserver;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/server/content/SyncManager$SettingsObserver;-><init>(Lcom/android/server/content/SyncManager;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/android/server/content/SyncManager;->mSettingsObserver:Lcom/android/server/content/SyncManager$SettingsObserver;
    ...
    iget-object v2, p0, Lcom/android/server/content/SyncManager;->mSettingsObserver:Lcom/android/server/content/SyncManager$SettingsObserver;
    ...
    .line 453
    sput-boolean v4, Lcom/android/server/content/SyncManager;->mIsEPSMode:Z
...
.method private postMonitorSyncProgressMessage(Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    .line 1105
    .end local v0    # "monitorMessage":Landroid/os/Message;
    :cond_0
    const-string v1, "SyncManager"
...
.method protected dumpSyncState(Ljava/io/PrintWriter;)V
    ...
    invoke-static/range {v34 .. v34}, Lcom/android/server/content/SyncManager$SyncHandler;->access$2200(Lcom/android/server/content/SyncManager$SyncHandler;)Ljava/lang/Long;
...
.method maybeRescheduleSync(Landroid/content/SyncResult;Lcom/android/server/content/SyncOperation;)V
    ...
    invoke-direct {v1, p2, v4, v5}, Lcom/android/server/content/SyncOperation;-><init>(Lcom/android/server/content/SyncOperation;J)V
    ...
    .restart local p2    # "operation":Lcom/android/server/content/SyncOperation;
    :cond_3
    const/4 v0, 0x1
    ...
    .restart local v1    # "operation":Lcom/android/server/content/SyncOperation;
    :cond_4
    iget-object v3, v1, Lcom/android/server/content/SyncOperation;->extras:Landroid/os/Bundle;
...
.method public scheduleSync(Landroid/accounts/Account;IILjava/lang/String;Landroid/os/Bundle;JJZ)V
    ...
    .end local v38    # "expedited":Ljava/lang/Boolean;
    .end local v46    # "isLoggable":Z
    :cond_8
    const/16 v46, 0x1
    ...
    .line 853
    .restart local v38    # "expedited":Ljava/lang/Boolean;
    .restart local v46    # "isLoggable":Z
    :cond_9
    move-object/from16 v0, p0
...
.method public scheduleSync(Landroid/content/ComponentName;IILandroid/os/Bundle;JJ)V
    ...
    .end local v19    # "expedited":Ljava/lang/Boolean;
    .end local v20    # "ignoreSettings":Z
    .end local v22    # "isEnabled":Z
    .end local v23    # "isLoggable":Z
    ...
    .restart local v19    # "expedited":Ljava/lang/Boolean;
    .restart local v20    # "ignoreSettings":Z
    .restart local v22    # "isEnabled":Z
    .restart local v23    # "isLoggable":Z
    :cond_5
    const/16 v24, 0x0
