...
.method static synthetic access$300(Lcom/android/server/AlarmManagerService;J)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/AlarmManagerService;
    .param p1, "x1"    # J
...
.method private removeLocked(Landroid/app/PendingIntent;)V
    ...
    const-string v5, "mPendingIdleUntil is removed."
...
.method private setImplLocked(Lcom/android/server/AlarmManagerService$Alarm;ZZ)V
    ...
    const-string v9, "Delta until alarm: "
    ...
    const-string v9, "Current mPendingIdleUntil: "
...
.method canBeGrouped(Ljava/lang/String;)Z
    .locals 10
    ...
    .line 699
    .local v2, "ignore_list_contain":[Ljava/lang/String;
    ...
    .line 700
    .local v3, "ignore_list_equal":[Ljava/lang/String;
    move-object v0, v2
...
.method deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    sget-boolean v5, Lcom/android/server/AlarmManagerService;->HTC_DEBUG:Z
    ...
    invoke-virtual {v13}, Lcom/android/server/AlarmManagerService$Alarm;->toHTCString()Ljava/lang/String;
    ...
    .line 2305
    const-string v12, "encrypted_name"
    ...
    iget-wide v8, v13, Lcom/android/server/AlarmManagerService$Alarm;->when:J
...
.method doAlarmGrouping(IJJILjava/lang/String;J)J
    .locals 8
    .param p1, "type"    # I
    .param p2, "when"    # J
    .param p4, "windowLength"    # J
    .param p6, "uid"    # I
    .param p7, "pkg_name"    # Ljava/lang/String;
    .param p8, "duration"    # J
    ...
    invoke-virtual {p0, p7}, Lcom/android/server/AlarmManagerService;->canBeGrouped(Ljava/lang/String;)Z
    ...
    const-string v7, "[AlarmGrouping] before:"
    ...
    const-string v7, "[AlarmGrouping] after:"
...
.method setImpl(IJJJLandroid/app/PendingIntent;ILandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
    ...
    .line 994
    .local v27, "sm":Lcom/android/server/HtcServiceMonitor;
    const-string v8, "sense_version"

    const/4 v9, 0x0

    invoke-static {v8, v9}, Lcom/htc/customization/HtcCustomizationSystemReaderImpl;->readString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/server/HtcServiceMonitor;->isAlarmGroupingOn()Z
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/server/HtcServiceMonitor;->getAlarmGroupingDuration()J
    ...
    invoke-virtual/range {v4 .. v13}, Lcom/android/server/AlarmManagerService;->doAlarmGrouping(IJJILjava/lang/String;J)J
    :try_end_0
    ...
    .line 1009
    .end local v27    # "sm":Lcom/android/server/HtcServiceMonitor;
    :cond_6
    :goto_1
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    const-string v9, "[Power_FDA] Exception from alarm grouping."
...
.method setTimeZoneImpl(Ljava/lang/String;)V
    ...
    const-string v7, "setKernelTimezone in setTimeZoneImpl() ="
...
.method triggerAlarmsLocked(Ljava/util/ArrayList;JJ)Z
    ...
    const-string v5, "mPendingIdleUntil is ready to go off."
