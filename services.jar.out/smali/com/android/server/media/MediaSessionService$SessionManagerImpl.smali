...
.method private dispatchAdjustVolumeLocked(IIILcom/android/server/media/MediaSessionRecord;)V
    ...
    # invokes: Lcom/android/server/media/MediaSessionService;->getAudioService()Landroid/media/IAudioService;
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService;->access$2700(Lcom/android/server/media/MediaSessionService;)Landroid/media/IAudioService;

    move-result-object v2

    # setter for: Lcom/android/server/media/MediaSessionService;->mAudioService:Landroid/media/IAudioService;
    invoke-static {v1, v2}, Lcom/android/server/media/MediaSessionService;->access$2602(Lcom/android/server/media/MediaSessionService;Landroid/media/IAudioService;)Landroid/media/IAudioService;
    ...
    invoke-interface {v1}, Landroid/media/IAudioService;->isDLNAPlaying()Z
    :try_end_0
    ...
    .line 945
    .end local v14    # "isDLNAPlaying":Z
    :cond_5
    :goto_2
    return-void

    .line 904
    .end local v15    # "preferSuggestedStream":Z
    :cond_6
    ...
    .line 921
    .restart local v14    # "isDLNAPlaying":Z
    .restart local v15    # "preferSuggestedStream":Z
    :catch_0
    move-exception v13
    ...
    const-string v2, "error check DLNA is playing : "
...
.method private dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService;->access$2100(Lcom/android/server/media/MediaSessionService;)I
...
.method public dispatchAdjustVolume(III)V
    ...
    const-string v7, "dispatchAdjustVol(suggestedStream:"
