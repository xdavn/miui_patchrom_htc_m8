...
.method static constructor <clinit>()V
    ...
    .line 223
    sput-boolean v2, Lcom/android/server/MountService;->Share_SD_only:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mLock:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mStartedUsers:[I
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mDisks:Landroid/util/ArrayMap;
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mVolumes:Landroid/util/ArrayMap;
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mRecords:Landroid/util/ArrayMap;
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mDiskScanLatches:Landroid/util/ArrayMap;
    ...
    iput-boolean v2, v0, Lcom/android/server/MountService;->mDaemonConnected:Z
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mUnmountLock:Ljava/lang/Object;
    ...
    .line 473
    new-instance v2, Lcom/android/server/MountService$MountServiceInternalImpl;

    const/4 v3, 0x0

    move-object/from16 v0, p0

    invoke-direct {v2, v0, v3}, Lcom/android/server/MountService$MountServiceInternalImpl;-><init>(Lcom/android/server/MountService;Lcom/android/server/MountService$1;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/MountService;->mMountServiceInternal:Lcom/android/server/MountService$MountServiceInternalImpl;
    ...
    .line 1541
    new-instance v2, Lcom/android/server/MountService$Callbacks;
    ...
    invoke-direct {v2, v3}, Lcom/android/server/MountService$Callbacks;-><init>(Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/MountService;->mCallbacks:Lcom/android/server/MountService$Callbacks;
    ...
    invoke-direct {v14, v11, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mSettingsFile:Landroid/util/AtomicFile;

    .line 1576
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/MountService;->mLock:Ljava/lang/Object;

    monitor-enter v3

    .line 1577
    :try_start_1
    invoke-direct/range {p0 .. p0}, Lcom/android/server/MountService;->readSettingsLocked()V
    ...
    iget-object v3, v0, Lcom/android/server/MountService;->mMountServiceInternal:Lcom/android/server/MountService$MountServiceInternalImpl;
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/NativeDaemonConnector;->setDebug(Z)V
    ...
    const-string v4, "cryptd"

    const/16 v5, 0x1f4

    const-string v6, "CryptdConnector"
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mCryptConnector:Lcom/android/server/NativeDaemonConnector;
    ...
    .line 1607
    invoke-direct/range {p0 .. p0}, Lcom/android/server/MountService;->addInternalVolume()V
    ...
    .end local v10    # "crypt_thread":Ljava/lang/Thread;
...
.method static synthetic access$1700(Lcom/android/server/MountService;)Landroid/security/KeyStore;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;

    .prologue
    .line 152
    iget-object v0, p0, Lcom/android/server/MountService;->mKeyStore:Landroid/security/KeyStore;
...
.method static synthetic access$1900(Lcom/android/server/MountService;)Ljava/lang/String;
    ...
    .prologue
    .line 152
    invoke-direct {p0}, Lcom/android/server/MountService;->getSdcardVolId()Ljava/lang/String;
...
.method static synthetic access$2000(Lcom/android/server/MountService;Ljava/lang/String;)Landroid/os/storage/VolumeInfo;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$2500(Lcom/android/server/MountService;Z)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 152
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->setMountISOEnabled(Z)I
...
.method static synthetic access$4100(Lcom/android/server/MountService;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method private copyLocaleFromMountService()V
    ...
    invoke-virtual {p0, v5}, Lcom/android/server/MountService;->getField(Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1104
    .end local v4    # "systemLocale":Ljava/lang/String;
    :goto_0
    return-void
    ...
    .restart local v4    # "systemLocale":Ljava/lang/String;
    :cond_0
    ...
    const-string v7, " from mount service"
    ...
    const-string v7, "Setting system properties to "
    ...
    invoke-virtual {v3}, Ljava/util/Locale;->isZawgyi()Z
    ...
    .line 1097
    const-string v2, "zy-MM"

    .line 1102
    :cond_1
    :goto_2
    const-string v5, "persist.sys.locale"
...
.method private getSdcardVolId()Ljava/lang/String;
    .locals 4
...
.method private getUsbOTGVolId()Ljava/lang/String;
    .locals 4
...
.method private handleDaemonConnected()V
    ...
    .line 1043
    .local v3, "userId":I
    invoke-direct {p0, v3}, Lcom/android/server/MountService;->onStartUser(I)V
    :try_end_1
    ...
    .line 1051
    iget-object v4, p0, Lcom/android/server/MountService;->mConnectedSignal:Ljava/util/concurrent/CountDownLatch;
    ...
    .line 1067
    iget-object v4, p0, Lcom/android/server/MountService;->mAsecsScanned:Ljava/util/concurrent/CountDownLatch;
...
.method private handleSystemReady()V
    ...
    invoke-virtual {v3, v6}, Landroid/app/admin/DevicePolicyManager;->getAllowStorageCardStatus(Landroid/content/ComponentName;)I
    ...
    .line 879
    invoke-virtual {p0, v10}, Lcom/android/server/MountService;->setSdcardRestricted(Z)V
    ...
    const-string v8, "EAS policy: SD card is "
    ...
    .line 893
    .local v5, "userId":I
    invoke-direct {p0, v5}, Lcom/android/server/MountService;->onStartUser(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    .line 896
    iget-boolean v6, p0, Lcom/android/server/MountService;->mAutoMountCDROMOnBoot:Z
    ...
    const-string v7, "Mount ISO while usb connected on Boot"

    invoke-static {v6, v7}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 898
    invoke-direct {p0, v9}, Lcom/android/server/MountService;->setMountISOEnabled(Z)I

    .line 899
    iput-boolean v10, p0, Lcom/android/server/MountService;->mAutoMountCDROMOnBoot:Z

    .line 903
    :cond_4
    iget-object v6, p0, Lcom/android/server/MountService;->mContext:Landroid/content/Context;

    invoke-static {v6}, Lcom/android/server/MountServiceIdler;->scheduleIdlePass(Landroid/content/Context;)V
...
.method private mountSdcard()V
    ...
    .line 3766
    .local v0, "sdVolId":Ljava/lang/String;
    if-eqz v0, :cond_0
...
.method private mountUsbOTG()V
    ...
    .prologue
    .line 3743
    invoke-direct {p0}, Lcom/android/server/MountService;->getUsbOTGVolId()Ljava/lang/String;
...
.method private onDiskScannedLocked(Landroid/os/storage/DiskInfo;)V
    ...
    invoke-static {v5, p1, v4}, Lcom/android/server/MountService$Callbacks;->access$2800(Lcom/android/server/MountService$Callbacks;Landroid/os/storage/DiskInfo;I)V
...
.method private onEventLocked(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v0, v5}, Lcom/android/server/MountService$Callbacks;->access$2700(Lcom/android/server/MountService$Callbacks;Landroid/os/storage/DiskInfo;)V
...
.method private onStartUser(I)V
    ...
    invoke-static {v4, v6, v0, v0}, Lcom/android/server/MountService$Callbacks;->access$2600(Lcom/android/server/MountService$Callbacks;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private onVolumeStateChangedLocked(Landroid/os/storage/VolumeInfo;II)V
    ...
    invoke-static {v13, v0, v1, v2}, Lcom/android/server/MountService$Callbacks;->access$2900(Lcom/android/server/MountService$Callbacks;Landroid/os/storage/VolumeInfo;II)V
    ...
    .line 1450
    const-string v13, "vold.sd_maxfilesize"
    ...
    invoke-virtual {v12, v14, v15}, Landroid/os/storage/StorageVolume;->setMaxFileSize(J)V

    .line 1451
    const-string v13, "MountService"

    const-string v14, "sd_maxfilesize = %d"
    ...
    # invokes: Lcom/android/server/MountService$Callbacks;->notifyStorageStateChanged(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    invoke-static {v13, v14, v9, v8}, Lcom/android/server/MountService$Callbacks;->access$2600(Lcom/android/server/MountService$Callbacks;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private resetIfReadyAndConnectedLocked()V
    ...
    const-string v7, "Thinking about reset, mSystemReady="
    ...
    const-string v7, ", mDaemonConnected="
    ...
    .line 944
    iget-object v5, p0, Lcom/android/server/MountService;->mDisks:Landroid/util/ArrayMap;
    ...
    const-string v6, "Failed to reset vold"
...
.method private setMountISOEnabled(Z)I
    .locals 1
    .param p1, "enable"    # Z
...
.method private shouldBenchmark()Z
    ...
    .line 395
    .restart local v5    # "rec":Landroid/os/storage/VolumeRecord;
...
.method public disableFilesystemEncryption(Ljava/lang/String;)I
    ...
    const-string v7, "password cannot be empty"
    ...
    .line 4028
    .local v3, "vol":Landroid/os/storage/VolumeInfo;
    invoke-virtual {v3}, Landroid/os/storage/VolumeInfo;->isPrimaryPhysical()Z
    ...
    .local v4, "ident":J
    :try_start_0
    iget-object v7, p0, Lcom/android/server/MountService;->mUnmountLock:Ljava/lang/Object;
    ...
    iput-object v6, p0, Lcom/android/server/MountService;->mUnmountSignal:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-virtual {v6, v8, v9}, Lcom/android/server/pm/PackageManagerService;->updateExternalMediaStatus(ZZ)V

    .line 4034
    iget-object v6, p0, Lcom/android/server/MountService;->mUnmountSignal:Ljava/util/concurrent/CountDownLatch;

    const-string v8, "mUnmountSignal"

    invoke-direct {p0, v6, v8}, Lcom/android/server/MountService;->waitForLatch(Ljava/util/concurrent/CountDownLatch;Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_2
    iget-object v6, p0, Lcom/android/server/MountService;->mCryptConnector:Lcom/android/server/NativeDaemonConnector;

    const-string v7, "cryptfs"
    ...
    const-string v10, "unlink"

    aput-object v10, v8, v9

    const/4 v9, 0x1

    iget-object v10, v3, Landroid/os/storage/VolumeInfo;->id:Ljava/lang/String;
    ...
    const-string v10, "disablefilecrypto"
    ...
    const-string v7, "disabling encryption enablefilecrypto successfully "
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/MountService;->mount(Ljava/lang/String;)V
    ...
    const-string v7, "Caught exception for disablefilecrypto"
...
.method public enableFilesystemEncryption(Ljava/lang/String;)I
    ...
    invoke-virtual {v5}, Landroid/os/storage/VolumeInfo;->isPrimaryPhysical()Z
    ...
    iget-object v10, v5, Landroid/os/storage/VolumeInfo;->id:Ljava/lang/String;
    ...
    .line 3988
    :try_start_3
    iget-object v6, p0, Lcom/android/server/MountService;->mKeyStore:Landroid/security/KeyStore;

    const-string v7, "sd_encryption_256"
    ...
    const-string v6, "persist.sys.ecryptfs_init"
    ...
    const-string v10, "enablefilelevelcrypto"
    ...
    .line 3993
    .local v4, "passphrase":Ljava/lang/String;
    iget-object v6, p0, Lcom/android/server/MountService;->mKeyStore:Landroid/security/KeyStore;
    ...
    .line 4006
    .end local v1    # "event":Lcom/android/server/NativeDaemonEvent;
    .end local v4    # "passphrase":Ljava/lang/String;
    :cond_2
    :goto_0
    const-string v6, "MountService"

    const-string v7, "enabling encryption enablefilecrypto successfully "
    ...
    const-string v10, "getkeyandenablefilelevlecrypto"
    ...
    .line 3999
    .restart local v4    # "passphrase":Ljava/lang/String;
    iget-object v6, p0, Lcom/android/server/MountService;->mKeyStore:Landroid/security/KeyStore;
    ...
    const-string v7, "Caught exception for enablefilecrypto"
...
.method public forgetAllVolumes()V
    ...
    .line 2023
    .local v5, "rec":Landroid/os/storage/VolumeRecord;
    iget-object v7, v5, Landroid/os/storage/VolumeRecord;->partGuid:Ljava/lang/String;
    ...
    invoke-direct {p0, v7}, Lcom/android/server/MountService;->forgetPartition(Ljava/lang/String;)V

    .line 2026
    :cond_0
    iget-object v7, p0, Lcom/android/server/MountService;->mCallbacks:Lcom/android/server/MountService$Callbacks;

    # invokes: Lcom/android/server/MountService$Callbacks;->notifyVolumeForgotten(Ljava/lang/String;)V
    invoke-static {v7, v1}, Lcom/android/server/MountService$Callbacks;->access$3100(Lcom/android/server/MountService$Callbacks;Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lcom/android/server/MountService;->mPrimaryStorageUuid:Ljava/lang/String;
    ...
    iput-object v7, p0, Lcom/android/server/MountService;->mPrimaryStorageUuid:Ljava/lang/String;
    ...
    .line 2039
    .local v6, "userId":I
    invoke-direct {p0, v6}, Lcom/android/server/MountService;->onStartUser(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public forgetVolume(Ljava/lang/String;)V
    ...
    .line 1992
    :try_start_0
    iget-object v5, p0, Lcom/android/server/MountService;->mRecords:Landroid/util/ArrayMap;
    ...
    iget-object v5, v3, Landroid/os/storage/VolumeRecord;->partGuid:Ljava/lang/String;
    ...
    invoke-direct {p0, v5}, Lcom/android/server/MountService;->forgetPartition(Ljava/lang/String;)V
    ...
    # invokes: Lcom/android/server/MountService$Callbacks;->notifyVolumeForgotten(Ljava/lang/String;)V
    invoke-static {v5, p1}, Lcom/android/server/MountService$Callbacks;->access$3100(Lcom/android/server/MountService$Callbacks;Ljava/lang/String;)V
    ...
    iput-object v5, p0, Lcom/android/server/MountService;->mPrimaryStorageUuid:Ljava/lang/String;
    ...
    .line 2009
    .local v4, "userId":I
    invoke-direct {p0, v4}, Lcom/android/server/MountService;->onStartUser(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public isSdEncryptionEnabled()Z
    ...
    .line 3812
    invoke-static {}, Lcom/android/server/MountService;->hasRemovableStorageSlot()Z
...
.method public mkdirs(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 2868
    :cond_1
    invoke-virtual {p0, v7}, Lcom/android/server/MountService;->getVolumes(I)[Landroid/os/storage/VolumeInfo;

    move-result-object v6

    .line 2869
    .local v6, "volumes":[Landroid/os/storage/VolumeInfo;
    const/4 v3, 0x0
    ...
    .line 2879
    .end local v3    # "i":I
    .end local v6    # "volumes":[Landroid/os/storage/VolumeInfo;
    :goto_1
    return v7
    ...
    .restart local v3    # "i":I
    .restart local v6    # "volumes":[Landroid/os/storage/VolumeInfo;
    :cond_2
    add-int/lit8 v3, v3, 0x1
...
.method public mount(Ljava/lang/String;)V
    ...
    const-string v5, "SD encrypted, but keystore is not ready"
    ...
    .line 1834
    iget-object v4, p0, Lcom/android/server/MountService;->mKeyStore:Landroid/security/KeyStore;

    const-string v5, "sd_encryption_256"
    ...
    invoke-virtual {v4, v5}, Landroid/security/KeyStore;->get(Ljava/lang/String;)[B
    ...
    .line 1836
    .local v2, "passphrase":Ljava/lang/String;
    iget-object v4, p0, Lcom/android/server/MountService;->mCryptConnector:Lcom/android/server/NativeDaemonConnector;
    ...
    invoke-direct {v8, v2}, Lcom/android/server/NativeDaemonConnector$SensitiveArg;-><init>(Ljava/lang/Object;)V
    ...
    .line 1841
    .end local v2    # "passphrase":Ljava/lang/String;
    :catch_0
    move-exception v0
...
.method public setPrimaryStorageUuid(Ljava/lang/String;Landroid/content/pm/IPackageMoveObserver;)V
    ...
    const-string v10, "Primary storage already at "
    ...
    :cond_0
    :try_start_1
    iget-object v7, p0, Lcom/android/server/MountService;->mMoveCallback:Landroid/content/pm/IPackageMoveObserver;
    ...
    const-string v9, "Move already in progress"
    ...
    const-string v9, "Skipping move to/from primary physical"
    ...
    invoke-direct {p0, v7}, Lcom/android/server/MountService;->onMoveStatusLocked(I)V
    ...
    invoke-direct {p0, v7}, Lcom/android/server/MountService;->findStorageForUuid(Ljava/lang/String;)Landroid/os/storage/VolumeInfo;
    ...
    .line 2136
    .local v5, "to":Landroid/os/storage/VolumeInfo;
    if-nez v2, :cond_6
    ...
    const-string v10, "Failing move due to missing from volume "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, p0, Lcom/android/server/MountService;->mPrimaryStorageUuid:Ljava/lang/String;
    ...
    .end local v5    # "to":Landroid/os/storage/VolumeInfo;
    :cond_5
    :goto_2
    return-void

    .line 2140
    .restart local v2    # "from":Landroid/os/storage/VolumeInfo;
    .restart local v5    # "to":Landroid/os/storage/VolumeInfo;
    :cond_6
    if-nez v5, :cond_7
    ...
    const-string v10, "Failing move due to missing to volume "
    ...
    const-string v12, "move_storage"

    aput-object v12, v10, v11

    const/4 v11, 0x1

    iget-object v12, v2, Landroid/os/storage/VolumeInfo;->id:Ljava/lang/String;

    aput-object v12, v10, v11

    const/4 v11, 0x2

    iget-object v12, v5, Landroid/os/storage/VolumeInfo;->id:Ljava/lang/String;
...
.method public setVolumeNickname(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lcom/android/server/MountService$Callbacks;->access$3000(Lcom/android/server/MountService$Callbacks;Landroid/os/storage/VolumeRecord;)V
