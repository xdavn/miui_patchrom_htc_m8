...
.field static final TRANSACTION_htcNotifyCallDisconnected:I = 0x20
...
.field static final TRANSACTION_notifySecondSignalStrengthForSubscriber:I = 0x21
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 52
    .local v4, "_arg1":Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;
    move-object/from16 v0, p0

    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->addOnSubscriptionsChangedListener(Ljava/lang/String;Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;)V
    ...
    .end local v4    # "_arg1":Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;
    :sswitch_2
    const-string v2, "com.android.internal.telephony.ITelephonyRegistry"
    ...
    .line 63
    .restart local v4    # "_arg1":Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;
    move-object/from16 v0, p0

    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->removeOnSubscriptionsChangedListener(Ljava/lang/String;Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;)V
    ...
    .line 92
    .local v5, "_arg2":Lcom/android/internal/telephony/IPhoneStateListener;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 95
    invoke-virtual/range {v2 .. v7}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->listenForSubscriber(ILjava/lang/String;Lcom/android/internal/telephony/IPhoneStateListener;IZ)V
    ...
    .end local v5    # "_arg2":Lcom/android/internal/telephony/IPhoneStateListener;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyCallStateForSubscriber(IILjava/lang/String;)V
    ...
    .line 137
    .local v5, "_arg2":Landroid/telephony/ServiceState;
    :goto_3
    move-object/from16 v0, p0

    invoke-virtual {v0, v3, v4, v5}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyServiceStateForPhoneId(IILandroid/telephony/ServiceState;)V
    ...
    .line 135
    .end local v5    # "_arg2":Landroid/telephony/ServiceState;
    :cond_2
    const/4 v5, 0x0

    .restart local v5    # "_arg2":Landroid/telephony/ServiceState;
    goto :goto_3
    ...
    .line 167
    .local v4, "_arg1":Landroid/telephony/SignalStrength;
    :goto_5
    move-object/from16 v0, p0

    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifySignalStrengthForSubscriber(ILandroid/telephony/SignalStrength;)V
    ...
    .line 165
    .end local v4    # "_arg1":Landroid/telephony/SignalStrength;
    :cond_4
    const/4 v4, 0x0

    .restart local v4    # "_arg1":Landroid/telephony/SignalStrength;
    goto :goto_5
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyMessageWaitingChangedForPhoneId(IIZ)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyCallForwardingChangedForSubscriber(IZ)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyDataActivityForSubscriber(II)V
    ...
    .line 252
    .local v9, "_arg6":Landroid/net/NetworkCapabilities;
    :goto_b
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 255
    invoke-virtual/range {v2 .. v11}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyDataConnection(IZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;IZ)V
    ...
    .end local v9    # "_arg6":Landroid/net/NetworkCapabilities;
    ...
    .restart local v9    # "_arg6":Landroid/net/NetworkCapabilities;
    goto :goto_b
    ...
    .line 282
    .local v9, "_arg6":Landroid/net/LinkProperties;
    :goto_e
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    check-cast v10, Landroid/net/NetworkCapabilities;

    .line 289
    .local v10, "_arg7":Landroid/net/NetworkCapabilities;
    :goto_f
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 292
    invoke-virtual/range {v2 .. v12}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyDataConnectionForSubscriber(IIZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;IZ)V
    ...
    .end local v9    # "_arg6":Landroid/net/LinkProperties;
    .end local v10    # "_arg7":Landroid/net/NetworkCapabilities;
    ...
    .restart local v9    # "_arg6":Landroid/net/LinkProperties;
    goto :goto_e
    ...
    .restart local v10    # "_arg7":Landroid/net/NetworkCapabilities;
    goto :goto_f
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyDataConnectionFailedForSubscriber(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyCellLocationForSubscriber(ILandroid/os/Bundle;)V
    ...
    .line 364
    .local v13, "_arg0":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    move-object/from16 v0, p0

    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyCellInfo(Ljava/util/List;)V
    ...
    .line 370
    .end local v13    # "_arg0":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    :sswitch_17
    const-string v2, "com.android.internal.telephony.ITelephonyRegistry"
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyPreciseCallState(III)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyDisconnectCause(II)V
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyPreciseDataConnectionFailed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 414
    .local v16, "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    move-object/from16 v0, p0

    move-object/from16 v1, v16

    invoke-virtual {v0, v3, v1}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyCellInfoForSubscriber(ILjava/util/List;)V
    ...
    .line 420
    .end local v3    # "_arg0":I
    .end local v16    # "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    :sswitch_1b
    const-string v2, "com.android.internal.telephony.ITelephonyRegistry"
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyDataConnectionRealTimeInfo(Landroid/telephony/DataConnectionRealTimeInfo;)V
    ...
    .line 437
    sget-object v2, Landroid/telephony/VoLteServiceState;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyVoLteServiceStateChanged(Landroid/telephony/VoLteServiceState;)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyOemHookRawEventForSubscriber(I[B)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifyCarrierNetworkChange(Z)V
    ...
    invoke-virtual {v0, v14, v15, v4}, Lcom/android/internal/telephony/ITelephonyRegistry$Stub;->notifySecondSignalStrengthForSubscriber(JLandroid/telephony/SignalStrength;)V
