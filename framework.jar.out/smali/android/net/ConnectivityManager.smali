...
.field public static final MAX_NETWORK_TYPE:I = 0x35
...
.field public static final TYPE_MOBILE_CALLERNAMEID:I = 0x35
...
.field public static final TYPE_MOBILE_VERIZONAPP:I = 0x34
...
.method public static setProcessDefaultNetwork(Landroid/net/Network;)Z
    ...
    const-string/jumbo v6, "setProcessDefaultNetwork for "
    ...
    const-string v6, " called by uid/pid="
...
.method public setUidNetworkRulesByInterface(ZILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v1, p1, p2, p3, p4}, Landroid/net/IConnectivityManager;->setUidNetworkRulesByInterface(ZILjava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public startUsingNetworkFeature(ILjava/lang/String;)I
    ...
    :try_start_0
    iget-object v9, p0, Landroid/net/ConnectivityManager;->mService:Landroid/net/IConnectivityManager;

    invoke-direct {p0, v2}, Landroid/net/ConnectivityManager;->inferLegacyTypeForNetworkCapabilities(Landroid/net/NetworkCapabilities;)I

    move-result v10

    const/4 v11, 0x0

    invoke-interface {v9, v10, v11}, Landroid/net/IConnectivityManager;->isNetworkSignaturePermitted(II)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v7, "startUsingNetworkFeature failed: "
    ...
    .line 982
    :cond_3
    invoke-direct {p0, v2}, Landroid/net/ConnectivityManager;->requestNetworkForFeatureLocked(Landroid/net/NetworkCapabilities;)Landroid/net/NetworkRequest;
    ...
    .line 988
    .restart local v1    # "l":Landroid/net/ConnectivityManager$LegacyRequest;
    :cond_4
    const-string v6, "ConnectivityManager"
...
.method public stopUsingNetworkFeature(ILjava/lang/String;)I
    ...
    invoke-interface {v4, v5, v6}, Landroid/net/IConnectivityManager;->isNetworkSignaturePermitted(II)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v6, "stopUsingNetworkFeature failed: "
