...
.method static synthetic access$2600(Landroid/media/MediaScanner;)I
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method static synthetic access$2700(Landroid/media/MediaScanner;)I
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner;
...
.method private initialize(Ljava/lang/String;)V
    ...
    .line 1518
    iput-boolean v4, p0, Landroid/media/MediaScanner;->mCaseInsensitivePaths:Z

    .line 1521
    sput v5, Landroid/media/MediaScanner;->mNotifyGalleryChange:I

    .line 1522
    sput v5, Landroid/media/MediaScanner;->mNotifyTotalChange:I

    .line 1528
    :cond_0
    iput v3, p0, Landroid/media/MediaScanner;->mInsertImageCount:I

    .line 1529
    iput v3, p0, Landroid/media/MediaScanner;->mInsertVideoCount:I

    .line 1530
    iput v3, p0, Landroid/media/MediaScanner;->mInsertAudioCount:I

    .line 1531
    iput v3, p0, Landroid/media/MediaScanner;->mInsertOtherCount:I

    .line 1532
    iput v3, p0, Landroid/media/MediaScanner;->mInsertTotalCount:I

    .line 1534
    iput v3, p0, Landroid/media/MediaScanner;->mUpdateImageCount:I

    .line 1535
    iput v3, p0, Landroid/media/MediaScanner;->mUpdateVideoCount:I

    .line 1536
    iput v3, p0, Landroid/media/MediaScanner;->mUpdateAudioCount:I

    .line 1537
    iput v3, p0, Landroid/media/MediaScanner;->mUpdateOtherCount:I

    .line 1539
    iput v3, p0, Landroid/media/MediaScanner;->mDeleteImageCount:I

    .line 1540
    iput v3, p0, Landroid/media/MediaScanner;->mDeleteVideoCount:I

    .line 1541
    iput v3, p0, Landroid/media/MediaScanner;->mDeleteAudioCount:I

    .line 1542
    iput v3, p0, Landroid/media/MediaScanner;->mDeleteOtherCount:I

    .line 1543
    iput v3, p0, Landroid/media/MediaScanner;->mDeleteTotalCount:I

    .line 1545
    iput v3, p0, Landroid/media/MediaScanner;->mCursorCount:I

    .line 1546
    iput v3, p0, Landroid/media/MediaScanner;->mTotalCount:I
...
.method private prescan(Ljava/lang/String;Z)V
    ...
    const-string v3, "[prescan] compute original size of images"
...
.method private processInternalDirectory([Ljava/lang/String;Z)V
    ...
    invoke-direct {v2, v3, v4, v5}, Landroid/media/MediaInserter;-><init>(Landroid/content/IContentProvider;Ljava/lang/String;I)V
    ...
    iget-object v3, p0, Landroid/media/MediaScanner;->mClient:Landroid/media/MediaScanner$MyMediaScannerClient;

    invoke-direct {p0, v2, v3, p2}, Landroid/media/MediaScanner;->processDirectory(Ljava/lang/String;Landroid/media/MediaScannerClient;Z)V
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v21, "=====scanDirectories===== volumeName = "
    ...
    iput-boolean v5, v0, Landroid/media/MediaScanner;->mStopScanning:Z
    ...
    .line 1569
    .local v12, "prescan":J
    invoke-static {}, Landroid/media/MediaFile;->getMediaFileExtensions()Ljava/lang/String;

    move-result-object v5

    move-object/from16 v0, p0

    invoke-virtual {v0, v5}, Landroid/media/MediaScanner;->setMediaFileExtension(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v5}, Landroid/media/MediaScanner;->processInternalDirectory([Ljava/lang/String;Z)V
    ...
    iget v5, v0, Landroid/media/MediaScanner;->mCursorCount:I
    ...
    iput v5, v0, Landroid/media/MediaScanner;->mTotalCount:I
    ...
    const-string/jumbo v21, "postscan time: "
    ...
    const-string v21, "firstscan(media) time: "
    ...
    const-string/jumbo v21, "secondscan(non-media) time: "
    ...
    const-string v21, " [Total]    File(Image+Video+Audio+Others) in database : "
    ...
    const-string v20, "SQLException in MediaScanner.scan()"
    ...
    const-string v20, "UnsupportedOperationException in MediaScanner.scan()"
    ...
    const-string v20, "RemoteException in MediaScanner.scan()"
...
.method public scanSingleFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    const-string/jumbo v3, "scansingleFile finally"
