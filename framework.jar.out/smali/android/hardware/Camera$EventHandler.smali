...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3}, Landroid/hardware/Camera;->access$2400(Landroid/hardware/Camera;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v14, v3}, Landroid/hardware/Camera$AutoFocusCallback;->onAutoFocus(ZLandroid/hardware/Camera;)V
    ...
    invoke-static {v4}, Landroid/hardware/Camera;->access$2300(Landroid/hardware/Camera;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    ...
    new-instance v15, Landroid/hardware/camera2/impl/CameraMetadataNative;
    ...
    # getter for: Landroid/hardware/Camera;->mMetadata:Landroid/hardware/camera2/impl/CameraMetadataNative;
    invoke-static {v3}, Landroid/hardware/Camera;->access$2300(Landroid/hardware/Camera;)Landroid/hardware/camera2/impl/CameraMetadataNative;

    move-result-object v3

    invoke-direct {v15, v3}, Landroid/hardware/camera2/impl/CameraMetadataNative;-><init>(Landroid/hardware/camera2/impl/CameraMetadataNative;)V
    ...
    # getter for: Landroid/hardware/Camera;->mMetadata:Landroid/hardware/camera2/impl/CameraMetadataNative;
    invoke-static {v5}, Landroid/hardware/Camera;->access$2300(Landroid/hardware/Camera;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    ...
    invoke-direct {v13, v15, v0, v3}, Landroid/hardware/camera2/CaptureResult;-><init>(Landroid/hardware/camera2/impl/CameraMetadataNative;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/impl/CaptureResultExtras;)V
    ...
    invoke-interface {v3, v11, v13, v4}, Landroid/hardware/Camera$HtcCallback;->onCaptureResult(Landroid/hardware/camera2/CameraCharacteristics;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/Camera;)V
