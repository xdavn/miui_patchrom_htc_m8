...
.method static synthetic access$2300(Landroid/hardware/Camera;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$2700(Landroid/hardware/Camera;)Landroid/hardware/Camera$Parameters;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method private cameraInitVersion(II)I
    ...
    .line 677
    iput-object v1, p0, Landroid/hardware/Camera;->mHtcCallback:Landroid/hardware/Camera$HtcCallback;
    ...
    invoke-direct {p0, v1, v0}, Landroid/hardware/Camera;->setEventHandler(ILandroid/os/Looper;)V
    ...
    sget v2, Landroid/hardware/Camera;->sIndexOfMain:I

    if-ne v1, v2, :cond_0

    .line 697
    sget-boolean v1, Landroid/hardware/Camera;->sIsFront:Z

    invoke-direct {p0, v4, v1}, Landroid/hardware/Camera;->setState(ZZ)V
    ...
    sget v2, Landroid/hardware/Camera;->sIndexOfFront:I
    ...
    invoke-direct {p0, v1, v4}, Landroid/hardware/Camera;->setState(ZZ)V

    .line 702
    invoke-direct {p0, v3}, Landroid/hardware/Camera;->processSubCam(Z)V
...
.method public static getParametersCopy(Landroid/hardware/Camera$Parameters;)Landroid/hardware/Camera$Parameters;
    ...
    invoke-static {p0}, Landroid/hardware/Camera$Parameters;->access$2600(Landroid/hardware/Camera$Parameters;)Landroid/hardware/Camera;
