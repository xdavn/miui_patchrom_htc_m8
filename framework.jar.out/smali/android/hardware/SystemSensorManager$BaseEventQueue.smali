...
.method private enableSensor(Landroid/hardware/Sensor;IILjava/lang/String;)I
    .locals 6
    .param p1, "sensor"    # Landroid/hardware/Sensor;
    .param p2, "rateUs"    # I
    .param p3, "maxBatchReportLatencyUs"    # I
    .param p4, "listener"    # Ljava/lang/String;
    ...
    invoke-static {v2, v3, v4, p2, p3}, Landroid/hardware/SystemSensorManager$BaseEventQueue;->nativeEnableSensor(JIII)I
    ...
    invoke-static {v2, v3, p4, v4}, Landroid/hardware/SystemSensorManager$BaseEventQueue;->nativeListenerSensor(JLjava/lang/String;I)V
...
# virtual methods
.method public addSensor(Landroid/hardware/Sensor;IILjava/lang/String;)Z
    .locals 4
    .param p1, "sensor"    # Landroid/hardware/Sensor;
    .param p2, "delayUs"    # I
    .param p3, "maxBatchReportLatencyUs"    # I
    ...
    .line 335
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/hardware/SystemSensorManager$BaseEventQueue;->enableSensor(Landroid/hardware/Sensor;IILjava/lang/String;)I
    ...
    invoke-direct {p0, p1, p2, v1, p4}, Landroid/hardware/SystemSensorManager$BaseEventQueue;->enableSensor(Landroid/hardware/Sensor;IILjava/lang/String;)I
    ...
    .line 339
    :cond_1
    invoke-virtual {p0, p1, v1, p4}, Landroid/hardware/SystemSensorManager$BaseEventQueue;->removeSensor(Landroid/hardware/Sensor;ZLjava/lang/String;)Z
