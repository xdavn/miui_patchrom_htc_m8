...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    const-string/jumbo v4, "profile.launch.sampling"
...
.method public static isTopApp()Z
    ...
    invoke-static {v2}, Landroid/app/ActivityThread$ApplicationThread;->access$3700(Landroid/app/ActivityThread$ApplicationThread;)I
...
.method public static main([Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "htc-activity"
    ...
    invoke-direct {v1, v8}, Landroid/app/ActivityThread;->attach(Z)V
    ...
    .line 5759
    .local v4, "start":J
    iget-object v6, v1, Landroid/app/ActivityThread;->mH:Landroid/app/ActivityThread$H;

    new-instance v7, Landroid/app/ActivityThread$4;

    invoke-direct {v7, v4, v5}, Landroid/app/ActivityThread$4;-><init>(J)V

    const-wide/16 v8, 0x7d0

    invoke-virtual {v6, v7, v8, v9}, Landroid/app/ActivityThread$H;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method public static systemMain()Landroid/app/ActivityThread;
    ...
    invoke-virtual {v0, v4, v7, v5}, Lcom/htc/customization/HtcCustomizationManager;->getCustomizationReader(Ljava/lang/String;IZ)Lcom/htc/customization/HtcCustomizationReader;
    ...
    invoke-interface {v1, v4, v2}, Lcom/htc/customization/HtcCustomizationReader;->readString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 5660
    invoke-static {v7}, Landroid/view/HardwareRenderer;->disable(Z)V
    ...
    const-string v6, "Disable hardware renderer, sense: "
...
.method public final acquireProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    const-string v3, ") is not ready, retry once"
