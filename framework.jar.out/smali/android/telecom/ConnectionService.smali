...
.field mPendingAbortedCallIds:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/telecom/ConnectionService;->mPendingAbortedCallIds:Ljava/util/Set;
...
.method private abort(Ljava/lang/String;)V
    ...
    .line 677
    iget-boolean v1, p0, Landroid/telecom/ConnectionService;->mAreAccountsInitialized:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Landroid/telecom/ConnectionService;->mPreInitializationConnectionRequests:Ljava/util/List;
    ...
    .line 680
    iget-object v1, p0, Landroid/telecom/ConnectionService;->mPendingAbortedCallIds:Ljava/util/Set;
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    iget-object v4, v0, Landroid/telecom/ConnectionService;->mPendingAbortedCallIds:Ljava/util/Set;
    ...
    .line 616
    const-string v4, "Call was aborted before creating conneciton: %s"
    ...
    invoke-static {v0, v4, v5}, Landroid/telecom/Log;->i(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
