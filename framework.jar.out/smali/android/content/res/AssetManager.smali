...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroid/content/res/AssetManager;->mValue:Landroid/util/TypedValue;
    ...
    iput-object v1, p0, Landroid/content/res/AssetManager;->mOffsets:[J

    .line 74
    const/4 v1, 0x0

    iput-object v1, p0, Landroid/content/res/AssetManager;->mStringBlocks:[Landroid/content/res/StringBlock;
    ...
    const-string v2, "Failed to add asset path for /system/framework/framework-res-htc/framework-res-htc.apk"
...
.method private static ensureSystemAssets()V
    ...
    .prologue
    .line 113
    sget-object v3, Landroid/content/res/AssetManager;->sSync:Ljava/lang/Object;
    ...
    .line 118
    .local v1, "system":Landroid/content/res/AssetManager;
    new-instance v0, Ljava/io/File;

    const-string v2, "/system/framework/framework-res-htc/framework-res-htc.apk"
    ...
    const-string v4, "Failed to add asset path into system for /system/framework/framework-res-htc/framework-res-htc.apk"
    ...
    invoke-virtual {v1, v2}, Landroid/content/res/AssetManager;->makeStringBlocks([Landroid/content/res/StringBlock;)V
