...
.method static constructor <clinit>()V
    ...
    .line 96
    new-instance v2, Landroid/view/Choreographer$1;

    invoke-direct {v2}, Landroid/view/Choreographer$1;-><init>()V

    sput-object v2, Landroid/view/Choreographer;->sThreadInstance:Ljava/lang/ThreadLocal;

    .line 109
    const-string v2, "debug.choreographer.vsync"

    invoke-static {v2, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    sput-boolean v2, Landroid/view/Choreographer;->USE_VSYNC:Z

    .line 113
    const-string v2, "debug.choreographer.frametime"

    invoke-static {v2, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    sput-boolean v2, Landroid/view/Choreographer;->USE_FRAME_TIME:Z

    .line 118
    const-string v2, "debug.choreographer.skipwarning"
    ...
    sput v2, Landroid/view/Choreographer;->SKIPPED_FRAME_WARNING_LIMIT:I

    .line 126
    new-instance v2, Landroid/view/Choreographer$2;

    invoke-direct {v2}, Landroid/view/Choreographer$2;-><init>()V

    sput-object v2, Landroid/view/Choreographer;->FRAME_CALLBACK_TOKEN:Ljava/lang/Object;
    ...
    sput-object v2, Landroid/view/Choreographer;->CALLBACK_TRACE_TITLES:[Ljava/lang/String;
...
.method doCallbacks(IJ)V
    ...
    iget-object v13, v0, Landroid/view/Choreographer;->mCallbackQueues:[Landroid/view/Choreographer$CallbackQueue;
    ...
    invoke-virtual {v13, v0, v1}, Landroid/view/Choreographer$CallbackQueue;->extractDueCallbacksLocked(J)Landroid/view/Choreographer$CallbackRecord;
    ...
    iput-boolean v13, v0, Landroid/view/Choreographer;->mCallbacksRunning:Z
    ...
    const-string/jumbo v13, "jitterNanos"
    ...
    invoke-static {v0, v1, v13, v2}, Landroid/os/Trace;->traceCounter(JLjava/lang/String;I)V
    ...
    :try_start_1
    sget-object v13, Landroid/view/Choreographer;->CALLBACK_TRACE_TITLES:[Ljava/lang/String;

    aget-object v13, v13, p1

    move-wide/from16 v0, v18

    invoke-static {v0, v1, v13}, Landroid/os/Trace;->traceBegin(JLjava/lang/String;)V
    ...
    sget-boolean v13, Landroid/view/Choreographer;->PERFORMANCE_LOG_ENABLED:Z
    ...
    const-string v19, "RunCallback: type="
    ...
    iget-object v0, v4, Landroid/view/Choreographer$CallbackRecord;->action:Ljava/lang/Object;
    ...
    iget-object v0, v4, Landroid/view/Choreographer$CallbackRecord;->token:Ljava/lang/Object;
    ...
    .line 691
    :cond_5
    iget-object v12, v5, Landroid/view/Choreographer$CallbackRecord;->next:Landroid/view/Choreographer$CallbackRecord;

    .line 692
    .local v12, "next":Landroid/view/Choreographer$CallbackRecord;
    move-object/from16 v0, p0
    ...
    .line 695
    .end local v12    # "next":Landroid/view/Choreographer$CallbackRecord;
    :catchall_1
    move-exception v13
    ...
    .line 692
    .restart local v12    # "next":Landroid/view/Choreographer$CallbackRecord;
    move-object/from16 v0, p0
